        ...
        <div class="dashboard -home-9 js-dashboard-home-9">
          <div class="dashboard__sidebar scroll-bar-1">
            ...
            <div class="sidebar -dashboard">
              ...
              <div class="sidebar__item -is-active -dark-bg-dark-2">
                <a href="dshb-bookmarks.html" class="d-flex items-center text-17 lh-1 fw-500 -dark-text-white">
                  <i class="text-20 icon-bookmark mr-15"></i>
                  Bookmarks
                </a>
              </div>
                          ...
                          <a href="#" class="relative d-block rounded-8 px-10 py-10 border-light">
                            <div class="row x-gap-20 y-gap-20 items-center">
                              <div class="col-md-auto">
                                <div class="shrink-0">
                                  <img class="w-1/1" src="{{ asset('template/img/dashboard/bookmarks/1.png') }}" alt="image">
                                </div>
                              </div>
                        ...
                        <div class="col-xl-6">
                          <a href="#" class="relative d-block rounded-8 px-10 py-10 border-light">
                            <div class="row x-gap-20 y-gap-20 items-center">
                              <div class="col-md-auto">
                                <div class="shrink-0">
                                  <img class="w-1/1" src="{{ asset('template/img/dashboard/bookmarks/2.png') }}" alt="image">
                                </div>
                              </div>
                        ...
                        <div class="col-xl-6">
                          <a href="#" class="relative d-block rounded-8 px-10 py-10 border-light">
                            <div class="row x-gap-20 y-gap-20 items-center">
                              <div class="col-md-auto">
                                <div class="shrink-0">
                                  <img class="w-1/1" src="{{ asset('template/img/dashboard/bookmarks/3.png') }}" alt="image">
                                </div>
                              </div>
                        ...
                        <div class="col-xl-6">
                          <a href="#" class="relative d-block rounded-8 px-10 py-10 border-light">
                            <div class="row x-gap-20 y-gap-20 items-center">
                              <div class="col-md-auto">
                                <div class="shrink-0">
                                  <img class="w-1/1" src="{{ asset('template/img/dashboard/bookmarks/4.png') }}" alt="image">
                                </div>
                              </div>
                        ...
                        <div class="col-xl-6">
                          <a href="#" class="relative d-block rounded-8 px-10 py-10 border-light">
                            <div class="row x-gap-20 y-gap-20 items-center">
                              <div class="col-md-auto">
                                <div class="shrink-0">
                                  <img class="w-1/1" src="{{ asset('template/img/dashboard/bookmarks/5.png') }}" alt="image">
                                </div>
                              </div>
                        ...
                        <div class="col-xl-6">
                          <a href="#" class="relative d-block rounded-8 px-10 py-10 border-light">
                            <div class="row x-gap-20 y-gap-20 items-center">
                              <div class="col-md-auto">
                                <div class="shrink-0">
                                  <img class="w-1/1" src="{{ asset('template/img/dashboard/bookmarks/6.png') }}" alt="image">
                                </div>
                              </div>
