        ...
        <div class="dashboard -home-9 js-dashboard-home-9">
          <div class="dashboard__sidebar scroll-bar-1">
            ...
            <div class="sidebar -dashboard">
              ...
              <div class="sidebar__item -is-active -dark-bg-dark-2">
                <a href="dshb-messages.html" class="d-flex items-center text-17 lh-1 fw-500 -dark-text-white">
                  <i class="text-20 icon-message mr-15"></i>
                  Messages
                </a>
              </div>
                    ...
                    <div class="py-30 px-30">
                      <div class="y-gap-30">
                        ...
                        <div class="d-flex justify-between">
                          <div class="d-flex items-center">
                            <div class="shrink-0">
                              <img src="{{ asset('template/img/avatars/small/1.png') }}" alt="image" class="size-50">
                            </div>
                            <div class="ml-10">
                        ...
                        <div class="d-flex justify-between">
                          <div class="d-flex items-center">
                            <div class="shrink-0">
                              <img src="{{ asset('template/img/avatars/small/2.png') }}" alt="image" class="size-50">
                            </div>
                            <div class="ml-10">
                        ...
                        <div class="d-flex justify-between">
                          <div class="d-flex items-center">
                            <div class="shrink-0">
                              <img src="{{ asset('template/img/avatars/small/3.png') }}" alt="image" class="size-50">
                            </div>
                            <div class="ml-10">
                        ...
                        <div class="d-flex justify-between">
                          <div class="d-flex items-center">
                            <div class="shrink-0">
                              <img src="{{ asset('template/img/avatars/small/4.png') }}" alt="image" class="size-50">
                            </div>
                            <div class="ml-10">
                        ...
                        <div class="d-flex justify-between">
                          <div class="d-flex items-center">
                            <div class="shrink-0">
                              <img src="{{ asset('template/img/avatars/small/5.png') }}" alt="image" class="size-50">
                            </div>
                            <div class="ml-10">
                        ...
                        <div class="d-flex justify-between">
                          <div class="d-flex items-center">
                            <div class="shrink-0">
                              <img src="{{ asset('template/img/avatars/small/6.png') }}" alt="image" class="size-50">
                            </div>
                            <div class="ml-10">
                        ...
                        <div class="d-flex justify-between">
                          <div class="d-flex items-center">
                            <div class="shrink-0">
                              <img src="{{ asset('template/img/avatars/small/7.png') }}" alt="image" class="size-50">
                            </div>
                            <div class="ml-10">
                        ...
                        <div class="d-flex justify-between">
                          <div class="d-flex items-center">
                            <div class="shrink-0">
                              <img src="{{ asset('template/img/avatars/small/8.png') }}" alt="image" class="size-50">
                            </div>
                            <div class="ml-10">
