              ...
              <div class="d-flex items-center">
                ...
                <div class="header__logo ml-30 md:ml-20">
                  <a data-barba href="{{ route('home') }}">
                    <img class="-light-d-none" src="{{ asset('template/img/general/logo.svg') }}" alt="logo">
                    <img class="-dark-d-none" src="{{ asset('template/img/general/logo-dark.svg') }}" alt="logo">
                  </a>
                </div>
              </div>
            </div>
              ...
              <div class="d-flex items-center">
                      ...
                      <div class="toggle-bottom -courses bg-white -dark-bg-dark-1 shadow-4 border-light rounded-8 mt-20">
                        <div class="px-30 py-30">
                          ...
                          <div class="d-flex mb-20">
                            <img class="size-80 fit-cover" src="{{ asset('template/img/menus/cart/1.png') }}" alt="image">
                          ...
                          <div class="d-flex mb-20">
                            <img class="size-80 fit-cover" src="{{ asset('template/img/menus/cart/2.png') }}" alt="image">
                      ...
                      <div class="toggle-bottom -notifications bg-white -dark-bg-dark-1 shadow-4 border-light rounded-8 mt-10">
                        <div class="py-30 px-30">
                          <div class="y-gap-40">
                            ...
                            <div class="d-flex items-center ">
                              <div class="shrink-0">
                                <img src="{{ asset('template/img/dashboard/actions/1.png') }}" alt="image">
                              </div>
                              <div class="ml-12">
                            ...
                            <div class="d-flex items-center border-top-light">
                              <div class="shrink-0">
                                <img src="{{ asset('template/img/dashboard/actions/2.png') }}" alt="image">
                              </div>
                              <div class="ml-12">
                            ...
                            <div class="d-flex items-center border-top-light">
                              <div class="shrink-0">
                                <img src="{{ asset('template/img/dashboard/actions/3.png') }}" alt="image">
                              </div>
                              <div class="ml-12">
                            ...
                            <div class="d-flex items-center border-top-light">
                              <div class="shrink-0">
                                <img src="{{ asset('template/img/dashboard/actions/4.png') }}" alt="image">
                              </div>
                              <div class="ml-12">
                            ...
                            <div class="d-flex items-center border-top-light">
                              <div class="shrink-0">
                                <img src="{{ asset('template/img/dashboard/actions/5.png') }}" alt="image">
                              </div>
                              <div class="ml-12">
                ...
                <div class="relative d-flex items-center ml-10">
                  <a href="#" data-el-toggle=".js-profile-toggle">
                    <img class="size-50" src="{{ asset('template/img/misc/user-profile.png') }}" alt="image">
                  </a>
                ...
                <div class="col-auto">
                  ...
                  <div class="breadcrumbs mt-10 pt-0 pb-0">
                    <div class="breadcrumbs__content">
                      ...
                      <div class="breadcrumbs__item">
                        <a href="{{ route('courses.list-3') }}">All courses</a>
                      </div>
                      <div class="breadcrumbs__item">
                        <a href="{{ route('courses.single-1') }}">User Experience Design</a>
                      </div>
                      <div class="breadcrumbs__item">
                        <a href="{{ route('courses.single-1') }}">User Interface</a>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="py-30 px-30">
                          ...
                          <div class="row y-gap-30">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                              <a href="#">
                                <div>
                                  <img class="rounded-8 w-1/1" src="{{ asset('template/img/coursesCards/1.png') }}" alt="image">
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                              <a href="#">
                                <div>
                                  <img class="rounded-8 w-1/1" src="{{ asset('template/img/coursesCards/2.png') }}" alt="image">
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                              <a href="#">
                                <div>
                                  <img class="rounded-8 w-1/1" src="{{ asset('template/img/coursesCards/3.png') }}" alt="image">
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                              <a href="#">
                                <div>
                                  <img class="rounded-8 w-1/1" src="{{ asset('template/img/coursesCards/4.png') }}" alt="image">
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                              <a href="#">
                                <div>
                                  <img class="rounded-8 w-1/1" src="{{ asset('template/img/coursesCards/5.png') }}" alt="image">
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                              <a href="#">
                                <div>
                                  <img class="rounded-8 w-1/1" src="{{ asset('template/img/coursesCards/6.png') }}" alt="image">
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                              <a href="#">
                                <div>
                                  <img class="rounded-8 w-1/1" src="{{ asset('template/img/coursesCards/7.png') }}" alt="image">
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6">
                              <a href="#">
                                <div>
                                  <img class="rounded-8 w-1/1" src="{{ asset('template/img/coursesCards/8.png') }}" alt="image">
                                </div>
                      ...
                      <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                        ...
                        <div class="py-30 px-30">
                          <div class="y-gap-40">
                            ...
                            <div class="d-flex ">
                              <div class="shrink-0">
                                <img src="{{ asset('template/img/dashboard/recent-courses/1.png') }}" alt="image">
                              </div>
                              <div class="ml-15">
                            ...
                            <div class="d-flex border-top-light">
                              <div class="shrink-0">
                                <img src="{{ asset('template/img/dashboard/recent-courses/2.png') }}" alt="image">
                              </div>
                              <div class="ml-15">
                            ...
                            <div class="d-flex border-top-light">
                              <div class="shrink-0">
                                <img src="{{ asset('template/img/dashboard/recent-courses/3.png') }}" alt="image">
                              </div>
                              <div class="ml-15">
                            ...
                            <div class="d-flex border-top-light">
                              <div class="shrink-0">
                                <img src="{{ asset('template/img/dashboard/recent-courses/4.png') }}" alt="image">
                              </div>
                              <div class="ml-15">
                                <h4 class="text-15 lh-16 fw-500">Complete Python Bootcamp From Zero to Hero in Python</h4>
                                <div class="d-flex items-center x-gap-20 y-gap-10 flex-wrap pt-10">
                  ...
                  <div class="row y-gap-30">
                    <div class="col-12">
                      <div class="d-flex items-center flex-column text-center py-40 px-40 rounded-16 bg-white -dark-bg-dark-1 shadow-4">
                        <img src="{{ asset('template/img/dashboard/demo/1.png') }}" alt="image">
                    ...
                    <div class="col-12">
                      <div class="pt-20 pb-30 px-30 rounded-16 bg-white -dark-bg-dark-1 shadow-4">
                        ...
                        <div class="">
                          <div class="d-flex">
                            <div class="shrink-0">
                              <img src="{{ asset('template/img/dashboard/badges/1.png') }}" alt="badge">
                            </div>
                          ...
                          <div class="d-flex x-gap-30 item-center pt-20">
                            <img src="{{ asset('template/img/dashboard/badges/2.png') }}" alt="badge">
                            <img src="{{ asset('template/img/dashboard/badges/3.png') }}" alt="badge">
                            <img src="{{ asset('template/img/dashboard/badges/4.png') }}" alt="badge">
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="mt-30">
                          <div class="row y-gap-10">
                            <div class="col-12">
                              <div class="d-flex items-center">
                                <div class="shrink-0">
                                  <img src="{{ asset('template/img/dashboard/online-users/1.png') }}" alt="badge">
                                </div>
                                <div class="ml-10">
                            ...
                            <div class="col-12">
                              <div class="d-flex items-center border-top-light pt-10">
                                <div class="shrink-0">
                                  <img src="{{ asset('template/img/dashboard/online-users/2.png') }}" alt="badge">
                                </div>
                                <div class="ml-10">
      ...
      <div class="sidebar-menu__content scroll-bar-1 py-30 px-40 sm:py-25 sm:px-20 bg-white -dark-bg-dark-1">
        ...
        <div class="relative js-menu-switch">
                ...
                <div class="accordion__content">
                  <div class="accordion__content__inner pl-20 pr-20 pb-20">
                    <div data-sidebar-menu-target="messages-2" class="row x-gap-10 y-gap-10 pointer">
                      <div class="col-auto">
                        <img src="{{ asset('template/img/dashboard/right-sidebar/messages/1.png') }}" alt="image">
                      </div>
                      <div class="col">
          ...
          <div data-sidebar-menu-open="messages-2" class="sidebar-menu__item -sidebar-menu">
            <div class="row x-gap-10 y-gap-10">
              <div class="col-auto">
                <img src="{{ asset('template/img/dashboard/right-sidebar/messages-2/1.png') }}" alt="image">
              </div>
              <div class="col">
              ...
              <div class="row y-gap-20">
                <div class="col-12">
                  <div class="row x-gap-10 y-gap-10 items-center">
                    <div class="col-auto">
                      <img src="{{ asset('template/img/dashboard/right-sidebar/messages-2/2.png') }}" alt="image">
                    </div>
                    <div class="col-auto">
                ...
                <div class="col-12">
                  <div class="row x-gap-10 y-gap-10 items-center justify-end">
                    ...
                    <div class="col-auto">
                      <img src="{{ asset('template/img/dashboard/right-sidebar/messages-2/3.png') }}" alt="image">
                    </div>
                  </div>
            ...
            <div class="tabs -pills js-tabs">
              ...
              <div class="tabs__content pt-30 js-tabs-content">
                ...
                <div class="tabs__pane -tab-item-1 is-active">
                  <div class="row x-gap-10 y-gap-10 items-center">
                    <div class="col-auto">
                      <img src="{{ asset('template/img/dashboard/right-sidebar/contacts/1.png') }}" alt="image">
                    </div>
                    <div class="col-auto">
