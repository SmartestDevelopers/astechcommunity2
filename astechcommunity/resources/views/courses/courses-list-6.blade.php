    ...
    <div class="content-wrapper  js-content-wrapper">
            ...
            <div class="row y-gap-20 justify-between items-center">
              ...
              <div class="col-auto">
                <div class="tabs__controls d-flex justify-center x-gap-10 js-tabs-controls">
                  ...
                  <div>
                    <button class="tabs__button px-20 py-8 rounded-8 js-tabs-button is-active" data-tab-target=".-tab-item-1" type="button">All</button>
                  </div>

                  <div>
                    <button class="tabs__button px-20 py-8 rounded-8 js-tabs-button " data-tab-target=".-tab-item-2" type="button">Trending</button>
                  </div>

                  <div>
                    <button class="tabs__button px-20 py-8 rounded-8 js-tabs-button " data-tab-target=".-tab-item-3" type="button">Popular</button>
                  </div>

                  <div>
                    <button class="tabs__button px-20 py-8 rounded-8 js-tabs-button " data-tab-target=".-tab-item-4" type="button">Fetured</button>
                  </div>
      ...
      <section class="layout-pt-md layout-pb-md">
        <div class="container">
          ...
          <div class="overflow-hidden pt-50 lg:pt-40 js-section-slider" data-gap="30" data-pagination="js-events-slider-pagination" data-nav-prev="js-events-slider-prev" data-nav-next="js-events-slider-next" data-slider-cols="xl-5 lg-3 md-2 sm-2" data-anim-wrap>
            <div class="swiper-wrapper">

              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-2" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image size-180 mx-auto">
                    <img class="fit-cover size-180 rounded-full" src="{{ asset('template/img/team/1.png') }}" alt="image">
                  ...
                  <div class="teamCard__content text-center">
                    ...
                    <div class="d-flex x-gap-15 justify-center pt-10">
                      ...
                      <div class="d-flex items-center">
                        <img class="mr-8" src="{{ asset('template/img/team/icons/1.svg') }}" alt="icon">
                        <div class="text-13 lh-12">692 Students</div>
                      </div>

                      <div class="d-flex items-center">
                        <img class="mr-8" src="{{ asset('template/img/team/icons/2.svg') }}" alt="icon">
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-3" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image size-180 mx-auto">
                    <img class="fit-cover size-180 rounded-full" src="{{ asset('template/img/team/2.png') }}" alt="image">
                    <div class="teamCard__socials rounded-full">
                      <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                        <a href="#"><i class="icon-facebook text-white"></i></a>
                        <a href="#"><i class="icon-twitter text-white"></i></a>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-4" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image size-180 mx-auto">
                    <img class="fit-cover size-180 rounded-full" src="{{ asset('template/img/team/3.png') }}" alt="image">
                    <div class="teamCard__socials rounded-full">
                      <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                        <a href="#"><i class="icon-facebook text-white"></i></a>
                        <a href="#"><i class="icon-twitter text-white"></i></a>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-5" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image size-180 mx-auto">
                    <img class="fit-cover size-180 rounded-full" src="{{ asset('template/img/team/4.png') }}" alt="image">
                    <div class="teamCard__socials rounded-full">
                      <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                        <a href="#"><i class="icon-facebook text-white"></i></a>
                        <a href="#"><i class="icon-twitter text-white"></i></a>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-6" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image size-180 mx-auto">
                    <img class="fit-cover size-180 rounded-full" src="{{ asset('template/img/team/5.png') }}" alt="image">
                    <div class="teamCard__socials rounded-full">
                      <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                        <a href="#"><i class="icon-facebook text-white"></i></a>
                        <a href="#"><i class="icon-twitter text-white"></i></a>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-7" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image size-180 mx-auto">
                    <img class="fit-cover size-180 rounded-full" src="{{ asset('template/img/team/6.png') }}" alt="image">
                    <div class="teamCard__socials rounded-full">
                      <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                        <a href="#"><i class="icon-facebook text-white"></i></a>
                        <a href="#"><i class="icon-twitter text-white"></i></a>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-8" class="teamCard -type-1 -teamCard-hover">
                  <div class="teamCard__image size-180 mx-auto">
                    <img class="fit-cover size-180 rounded-full" src="{{ asset('template/img/team/7.png') }}" alt="image">
                    <div class="teamCard__socials rounded-full">
                      <div class="d-flex x-gap-20 y-gap-10 justify-center items-center h-100">
                        <a href="#"><i class="icon-facebook text-white"></i></a>
                        <a href="#"><i class="icon-twitter text-white"></i></a>
            ...
            <div data-anim="slide-up delay-3" class="col-xl-9 col-lg-8">
              ...
              <div class="row y-gap-60">
                ...
                <div class="col-12 border-bottom-light">
                  <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 row y-gap-20 flex-row items-center">
                    <div class="col-xl-4">
                    ...
                    <div class="col">
                      ...
                      <div class="row x-gap-10 y-gap-10 items-center pt-10">
                        ...
                        <div class="col-auto">
                          <div class="d-flex items-center">
                            <img class="mr-8" src="{{ asset('template/img/coursesCards/icons/1.svg') }}" alt="icon">
                            <div class="text-14 lh-1">6 lesson</div>
                          </div>
                        </div>
                        ...
                        <div class="col-auto">
                          <div class="d-flex items-center">
                            <img class="mr-8" src="{{ asset('template/img/coursesCards/icons/2.svg') }}" alt="icon">
                            <div class="text-14 lh-1">3h 56m</div>
                          </div>
                        </div>
                        ...
                        <div class="col-auto">
                          <div class="d-flex items-center">
                            <img class="mr-8" src="{{ asset('template/img/coursesCards/icons/3.svg') }}" alt="icon">
                            <div class="text-14 lh-1">Beginner</div>
                          </div>
                        </div>
                ...
                <div class="col-12 border-bottom-light">
                  <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 row y-gap-20 flex-row items-center">
                    <div class="col-xl-4">
                      <div class="coursesCard__image rounded-8 relative">
                        <img class="w-1/1 rounded-8" src="{{ asset('template/img/coursesCards/7.png') }}" alt="image">
                        <div class="coursesCard__image_overlay rounded-8"></div>
                      </div>
                    </div>
