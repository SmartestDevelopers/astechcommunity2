        ...
        <div class="container">
          ...
          <div data-anim-wrap class="row y-gap-30 pt-60">
            ...
            <div class="col-lg-3 col-md-6">
              <div data-anim-child="slide-up delay-1">
                ...
                <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 py-10 px-10 border-light rounded-8">
                  <div class="relative">
                    <div class="coursesCard__image overflow-hidden rounded-8">
                      <img class="w-1/1" src="{{ asset('template/img/coursesCards/1.png') }}" alt="image">
                      <div class="coursesCard__image_overlay rounded-8"></div>
          ...
          <div data-anim-wrap class="row y-gap-30 pt-60">
            ...
            <div class="col-lg-4 col-md-6">
              <div data-anim-child="slide-up delay-1">
                ...
                <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 shadow-3 rounded-8">
                  <div class="relative">
                    <div class="coursesCard__image overflow-hidden rounded-top-8">
                      <img class="w-1/1" src="{{ asset('template/img/coursesCards/1.png') }}" alt="image">
                      <div class="coursesCard__image_overlay rounded-top-8"></div>
          ...
          <div data-anim-wrap class="row y-gap-30 pt-60">
            ...
            <div data-anim-child="slide-up delay-1" class="col-lg-6">
              <a href="{{ route('courses.list-1') }}" class="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
          ...
          <div data-anim-wrap class="row y-gap-30 pt-60">
            ...
            <div data-anim-child="slide-up delay-1" class="col-lg-6">
              <a href="{{ route('courses.list-1') }}" class="coursesCard -type-4 d-flex sm:d-block items-center">
                <div class="coursesCard__image overflow-hidden rounded-8 max-w-250">
                  <img class="w-1/1" src="{{ asset('template/img/coursesCards/1.png') }}" alt="image">
                  <div class="coursesCard__image_overlay rounded-8"></div>
                </div>
          ...
          <div data-anim-wrap class="row y-gap-30 pt-60">
            ...
            <div data-anim-child="slide-up delay-1" class="col-xl-9 col-lg-10 border-bottom-light">
              <a href="{{ route('courses.list-1') }}" class="coursesCard -type-1 row y-gap-20 flex-row items-center">
                <div class="col-xl-4">
