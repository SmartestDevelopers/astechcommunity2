        ...
        <div data-anim-wrap class="container">
          ...
          <div class="row y-gap-30">
            ...
            <div data-anim-child="slide-up delay-1" class="col-lg-4 col-md-6">
              ...
              <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 rounded-8 bg-white shadow-3">
                <div class="relative">
            ...
            <div data-anim-child="slide-up delay-7" class="col-lg-4 col-md-6">
            ...
            <div data-anim-child="slide-up delay-8" class="col-lg-4 col-md-6">
            ...
            <div data-anim-child="slide-up delay-9" class="col-lg-4 col-md-6">
