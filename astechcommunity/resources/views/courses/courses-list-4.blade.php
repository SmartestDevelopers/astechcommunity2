              ...
              <div class="row x-gap-20 y-gap-20">
                  ...
                  <div class="dropdown js-dropdown js-category-active">
                    ...
                    <div class="toggle-element -dropdown -dark-bg-dark-2 -dark-border-white-10 js-click-dropdown js-category-toggle">
                      <div class="text-14 y-gap-15 js-dropdown-list">
                        ...
                        <div><a href="#" class="d-block js-dropdown-link">Art</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Exercise</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Software</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Music</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Material</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Photography</a></div>
                ...
                <div class="col-auto">
                  ...
                  <div class="dropdown js-dropdown js-ratings-active">
                    <div class="dropdown__button d-flex items-center text-14 rounded-8 px-20 py-10 text-14 lh-12" data-el-toggle=".js-ratings-toggle" data-el-toggle-active=".js-ratings-active">
                      <span class="js-dropdown-title">Ratings</span>
                      <i class="icon text-9 ml-40 icon-chevron-down"></i>
                    </div>

                    <div class="toggle-element -dropdown -dark-bg-dark-2 -dark-border-white-10 js-click-dropdown js-ratings-toggle">
                      <div class="text-14 y-gap-15 js-dropdown-list">

                        <div><a href="#" class="d-block js-dropdown-link">4.5 &amp; up</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">4.0 &amp; up</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">3.5 &amp; up</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">3.0 &amp; up</a></div>
                ...
                <div class="col-auto">
                  ...
                  <div class="dropdown js-dropdown js-instructors-active">
                    <div class="dropdown__button d-flex items-center text-14 rounded-8 px-20 py-10 text-14 lh-12" data-el-toggle=".js-instructors-toggle" data-el-toggle-active=".js-instructors-active">
                      <span class="js-dropdown-title">Instructors</span>
                      <i class="icon text-9 ml-40 icon-chevron-down"></i>
                    </div>

                    <div class="toggle-element -dropdown -dark-bg-dark-2 -dark-border-white-10 js-click-dropdown js-instructors-toggle">
                      <div class="text-14 y-gap-15 js-dropdown-list">

                        <div><a href="#" class="d-block js-dropdown-link">Jane Cooper</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Jenny Wilson</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Robert Fox</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Jacob Jones</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Albert Flores</a></div>
                ...
                <div class="col-auto">
                  ...
                  <div class="dropdown js-dropdown js-price-active">
                    <div class="dropdown__button d-flex items-center text-14 rounded-8 px-20 py-10 text-14 lh-12" data-el-toggle=".js-price-toggle" data-el-toggle-active=".js-price-active">
                      <span class="js-dropdown-title">Price</span>
                      <i class="icon text-9 ml-40 icon-chevron-down"></i>
                    </div>

                    <div class="toggle-element -dropdown -dark-bg-dark-2 -dark-border-white-10 js-click-dropdown js-price-toggle">
                      <div class="text-14 y-gap-15 js-dropdown-list">

                        <div><a href="#" class="d-block js-dropdown-link">All</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Free</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Paid</a></div>
                ...
                <div class="col-auto">
                  ...
                  <div class="dropdown js-dropdown js-level-active">
                    <div class="dropdown__button d-flex items-center text-14 rounded-8 px-20 py-10 text-14 lh-12" data-el-toggle=".js-level-toggle" data-el-toggle-active=".js-level-active">
                      <span class="js-dropdown-title">Level</span>
                      <i class="icon text-9 ml-40 icon-chevron-down"></i>
                    </div>

                    <div class="toggle-element -dropdown -dark-bg-dark-2 -dark-border-white-10 js-click-dropdown js-level-toggle">
                      <div class="text-14 y-gap-15 js-dropdown-list">

                        <div><a href="#" class="d-block js-dropdown-link">All Levels</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Beginner</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Intermediate</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">Expert</a></div>
                ...
                <div class="col-auto">
                  ...
                  <div class="dropdown js-dropdown js-langunage-active">
                    <div class="dropdown__button d-flex items-center text-14 rounded-8 px-20 py-10 text-14 lh-12" data-el-toggle=".js-langunage-toggle" data-el-toggle-active=".js-langunage-active">
                      <span class="js-dropdown-title">Langunage</span>
                      <i class="icon text-9 ml-40 icon-chevron-down"></i>
                    </div>

                    <div class="toggle-element -dropdown -dark-bg-dark-2 -dark-border-white-10 js-click-dropdown js-langunage-toggle">
                      <div class="text-14 y-gap-15 js-dropdown-list">

                        <div><a href="#" class="d-block js-dropdown-link">English</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">French</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">German</a></div>
                ...
                <div class="col-auto">
                  ...
                  <div class="dropdown js-dropdown js-duration-active">
                    <div class="dropdown__button d-flex items-center text-14 rounded-8 px-20 py-10 text-14 lh-12" data-el-toggle=".js-duration-toggle" data-el-toggle-active=".js-duration-active">
                      <span class="js-dropdown-title">Duration</span>
                      <i class="icon text-9 ml-40 icon-chevron-down"></i>
                    </div>

                    <div class="toggle-element -dropdown -dark-bg-dark-2 -dark-border-white-10 js-click-dropdown js-duration-toggle">
                      <div class="text-14 y-gap-15 js-dropdown-list">

                        <div><a href="#" class="d-block js-dropdown-link">Less than 3 hours</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">4 - 7 hours</a></div>

                        <div><a href="#" class="d-block js-dropdown-link">8 - 18 hours </a></div>

                        <div><a href="#" class="d-block js-dropdown-link">20+ Hours</a></div>
          ...
          <div class="row y-gap-30">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
              ...
              <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 ">
                <div class="relative">
                  <div class="coursesCard__image overflow-hidden rounded-8">
                    <img class="w-1/1" src="{{ asset('template/img/coursesCards/9.png') }}" alt="image">
                    <div class="coursesCard__image_overlay rounded-8"></div>
                  </div>
                  <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
              ...
              <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 ">
                <div class="relative">
                  <div class="coursesCard__image overflow-hidden rounded-8">
                    <img class="w-1/1" src="{{ asset('template/img/coursesCards/10.png') }}" alt="image">
                    <div class="coursesCard__image_overlay rounded-8"></div>
                  </div>
                  <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
              ...
              <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 ">
                <div class="relative">
                  <div class="coursesCard__image overflow-hidden rounded-8">
                    <img class="w-1/1" src="{{ asset('template/img/coursesCards/11.png') }}" alt="image">
                    <div class="coursesCard__image_overlay rounded-8"></div>
                  </div>
                  <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
              ...
              <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 ">
                <div class="relative">
                  <div class="coursesCard__image overflow-hidden rounded-8">
                    <img class="w-1/1" src="{{ asset('template/img/coursesCards/12.png') }}" alt="image">
                    <div class="coursesCard__image_overlay rounded-8"></div>
                  </div>
                  <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
