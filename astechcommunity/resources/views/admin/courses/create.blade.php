    ...
    <div class="card-body">
      ...
      <div class="form-row">
        <div class="form-group col-md-4">
          ...
          <input type="number" min="0" name="duration_hours" value="{{ old('duration_hours', 0) }}" class="form-control">
        </div>
        <div class="form-group col-md-4">
          <label>Duration (Minutes)</label>
          <input type="number" min="0" max="59" name="duration_minutes" value="{{ old('duration_minutes', 0) }}" class="form-control">
        </div>
        <div class="form-group col-md-4">
          <label>Total Lessons</label>
          <input type="number" min="0" name="total_lessons" value="{{ old('total_lessons', 0) }}" class="form-control">
        </div>
      </div>
