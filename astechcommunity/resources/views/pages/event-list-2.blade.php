                    ...
                    <div class="sidebar-content -recent y-gap-20">
                      ...
                      <div class="sidebar-recent d-flex items-center">
                        <div class="sidebar-recent__image mr-15">
                          <img src="{{ asset('template/img/blog-list/1.png') }}" alt="image">
                        </div>
                      ...
                      <div class="sidebar-recent d-flex items-center">
                        <div class="sidebar-recent__image mr-15">
                          <img src="{{ asset('template/img/blog-list/2.png') }}" alt="image">
                        </div>
                      ...
                      <div class="sidebar-recent d-flex items-center">
                        <div class="sidebar-recent__image mr-15">
                          <img src="{{ asset('template/img/blog-list/3.png') }}" alt="image">
                        </div>
            ...
            <div class="col-lg-9 lg:order-1">
              ...
              <div data-anim="slide-up delay-4" class="row y-gap-30">
                ...
                <div class="col-lg-4 col-md-6">
                  <a href="#" class="eventCard -type-2 bg-white">
                    <div class="eventCard__img">
                      <img class="w-1/1 rounded-top-8" src="{{ asset('template/img/event-list/1.png') }}" alt="image">
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <a href="#" class="eventCard -type-2 bg-white">
                    <div class="eventCard__img">
                      <img class="w-1/1 rounded-top-8" src="{{ asset('template/img/event-list/2.png') }}" alt="image">
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <a href="#" class="eventCard -type-2 bg-white">
                    <div class="eventCard__img">
                      <img class="w-1/1 rounded-top-8" src="{{ asset('template/img/event-list/3.png') }}" alt="image">
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <a href="#" class="eventCard -type-2 bg-white">
                    <div class="eventCard__img">
                      <img class="w-1/1 rounded-top-8" src="{{ asset('template/img/event-list/4.png') }}" alt="image">
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <a href="#" class="eventCard -type-2 bg-white">
                    <div class="eventCard__img">
                      <img class="w-1/1 rounded-top-8" src="{{ asset('template/img/event-list/5.png') }}" alt="image">
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <a href="#" class="eventCard -type-2 bg-white">
                    <div class="eventCard__img">
                      <img class="w-1/1 rounded-top-8" src="{{ asset('template/img/event-list/6.png') }}" alt="image">
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <a href="#" class="eventCard -type-2 bg-white">
                    <div class="eventCard__img">
                      <img class="w-1/1 rounded-top-8" src="{{ asset('template/img/event-list/7.png') }}" alt="image">
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <a href="#" class="eventCard -type-2 bg-white">
                    <div class="eventCard__img">
                      <img class="w-1/1 rounded-top-8" src="{{ asset('template/img/event-list/8.png') }}" alt="image">
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                  <a href="#" class="eventCard -type-2 bg-white">
                    <div class="eventCard__img">
                      <img class="w-1/1 rounded-top-8" src="{{ asset('template/img/event-list/9.png') }}" alt="image">
                    </div>
