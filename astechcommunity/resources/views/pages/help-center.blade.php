        ...
        <div data-anim-wrap class="container">
          ...
          <div class="row y-gap-30 justify-between pt-90 lg:pt-50">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="py-40 px-45 rounded-16 bg-light-4">
                <div class="d-flex justify-center items-center size-70 rounded-full bg-white">
                  <img src="{{ asset('template/img/help-center/1.svg') }}" alt="icon">
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="py-40 px-45 rounded-16 bg-light-4">
                <div class="d-flex justify-center items-center size-70 rounded-full bg-white">
                  <img src="{{ asset('template/img/help-center/2.svg') }}" alt="icon">
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="py-40 px-45 rounded-16 bg-light-4">
                <div class="d-flex justify-center items-center size-70 rounded-full bg-white">
                  <img src="{{ asset('template/img/help-center/3.svg') }}" alt="icon">
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="py-40 px-45 rounded-16 bg-light-4">
                <div class="d-flex justify-center items-center size-70 rounded-full bg-white">
                  <img src="{{ asset('template/img/help-center/4.svg') }}" alt="icon">
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="py-40 px-45 rounded-16 bg-light-4">
                <div class="d-flex justify-center items-center size-70 rounded-full bg-white">
                  <img src="{{ asset('template/img/help-center/5.svg') }}" alt="icon">
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="py-40 px-45 rounded-16 bg-light-4">
                <div class="d-flex justify-center items-center size-70 rounded-full bg-white">
                  <img src="{{ asset('template/img/help-center/6.svg') }}" alt="icon">
                </div>
