          ...
          <div class="row y-gap-60 justify-between items-center">
              ...
              <div class="js-shop-slider">
                <div class="shopSingle-preview__image js-slider-slider">
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <a data-barba href="img/shop/single/1.png') }}" class="gallery__item js-gallery" data-gallery="gallery1">
                        <div class="ratio ratio-63:57">
                          <img class="absolute-full-center rounded-8" src="{{ asset('template/img/shop/single/1.png') }}" alt="project image">
                        </div>
                    ...
                    <div class="swiper-slide">
                      <a data-barba href="img/shop/single/2.png') }}" class="gallery__item js-gallery" data-gallery="gallery1">
                        <div class="ratio ratio-63:57">
                          <img class="absolute-full-center rounded-8" src="{{ asset('template/img/shop/single/2.png') }}" alt="project image">
                        </div>
                    ...
                    <div class="swiper-slide">
                      <a data-barba href="img/shop/single/3.png') }}" class="gallery__item js-gallery" data-gallery="gallery1">
                        <div class="ratio ratio-63:57">
                          <img class="absolute-full-center rounded-8" src="{{ asset('template/img/shop/single/3.png') }}" alt="project image">
                        </div>
                    ...
                    <div class="swiper-slide">
                      <a data-barba href="img/shop/single/4.png') }}" class="gallery__item js-gallery" data-gallery="gallery1">
                        <div class="ratio ratio-63:57">
                          <img class="absolute-full-center rounded-8" src="{{ asset('template/img/shop/single/4.png') }}" alt="project image">
                        </div>
                ...
                <div class="row y-gap-10 x-gap-10 pt-10 js-slider-pagination">
                  ...
                  <div data-cursor class="col-auto gallery__item">
                    <img class="size-90 object-cover rounded-8" src="{{ asset('template/img/shop/single/1.png') }}" alt="project image">
                  </div>

                  <div data-cursor class="col-auto gallery__item">
                    <img class="size-90 object-cover rounded-8" src="{{ asset('template/img/shop/single/2.png') }}" alt="project image">
                  </div>

                  <div data-cursor class="col-auto gallery__item">
                    <img class="size-90 object-cover rounded-8" src="{{ asset('template/img/shop/single/3.png') }}" alt="project image">
                  </div>

                  <div data-cursor class="col-auto gallery__item">
                    <img class="size-90 object-cover rounded-8" src="{{ asset('template/img/shop/single/4.png') }}" alt="project image">
                  </div>
            ...
            <div class="col-lg-5">
              <div class="pb-90 md:pb-0">
                <h2 class="text-30 fw-500 mt-4">Wild Cosmos blue hoodie</h2>
                <div class="text-24 fw-500 text-purple-1 mt-15">$18.00</div>
        ...
        <div class="container">
          ...
          <div class="row y-gap-32 pt-60 sm:pt-40">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="productCard -type-1 text-center">
                <div class="productCard__image">
                  <img src="{{ asset('template/img/shop/products/1.png') }}" alt="Product image">
                ...
                <div class="productCard__content mt-20">
                  ...
                  <div class="productCard__button d-inline-block">
                    <a href="#" class="button -md -outline-purple-1 -rounded text-dark-1 mt-15">Add To Cart</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="productCard -type-1 text-center">
                <div class="productCard__image">
                  <img src="{{ asset('template/img/shop/products/2.png') }}" alt="Product image">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="productCard -type-1 text-center">
                <div class="productCard__image">
                  <img src="{{ asset('template/img/shop/products/3.png') }}" alt="Product image">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="productCard -type-1 text-center">
                <div class="productCard__image">
                  <img src="{{ asset('template/img/shop/products/4.png') }}" alt="Product image">
