      ...
      <section class="layout-pt-md layout-pb-lg">
        <div data-anim-wrap class="container">
          <div class="row y-gap-30 justify-center">
            ...
            <div data-anim="slide-up delay-1" class="col-lg-10 col-md-11">
              <div class="blogCard -type-3">
                <div class="row y-gap-30 items-center">
                  <div class="col-lg-6">
                    <div class="blogCard__image">
                      <img class="rounded-8" src="{{ asset('template/img/blog-list/big/1.png') }}" alt="image">
                    </div>
                  </div>

                  <div class="col-lg-6">
                    <div class="blogCard__content pl-60 lg:pl-40 md:pl-0">
                      <a href="blog-single.html" class="blogCard__category text-14 lh-1 text-purple-1 fw-500">EDUCATION</a>
                      <h4 class="blogCard__title text-24 lh-15 text-dark-4 fw-500 mt-15">Eco-Education in Our Lives: We Can Change the Future</h4>
                      <p class="blogCard__text mt-20">Our features, journey, tips and us being us. Lorem ipsum dolor sit amet, accumsan in, tempor dictum neque.</p>
                      <div class="blogCard__button d-inline-block mt-20">
                        <a href="#" class="button -sm -purple-3 text-purple-1">
                          Read More
                        </a>
                      </div>
                    </div>
            ...
            <div data-anim="slide-up delay-1" class="col-lg-10 col-md-11">
              <div class="blogCard -type-3">
                <div class="row y-gap-30 items-center">
                  <div class="col-lg-6">
                    <div class="blogCard__image">
                      <img class="rounded-8" src="{{ asset('template/img/blog-list/big/2.png') }}" alt="image">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="blogCard__content pl-60 lg:pl-40 md:pl-0">
                      <a href="blog-single.html" class="blogCard__category text-14 lh-1 text-purple-1 fw-500">EDUCATION</a>
                      <h4 class="blogCard__title text-24 lh-15 text-dark-4 fw-500 mt-15">8 great design trends that are making a come-back in 2021</h4>
                      <p class="blogCard__text mt-20">Our features, journey, tips and us being us. Lorem ipsum dolor sit amet, accumsan in, tempor dictum neque.</p>
                      <div class="blogCard__button d-inline-block mt-20">
                        <a href="#" class="button -sm -purple-3 text-purple-1">
                          Read More
            ...
            <div data-anim="slide-up delay-1" class="col-lg-10 col-md-11">
              <div class="blogCard -type-3">
                <div class="row y-gap-30 items-center">
                  <div class="col-lg-6">
                    <div class="blogCard__image">
                      <img class="rounded-8" src="{{ asset('template/img/blog-list/big/3.png') }}" alt="image">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="blogCard__content pl-60 lg:pl-40 md:pl-0">
                      <a href="blog-single.html" class="blogCard__category text-14 lh-1 text-purple-1 fw-500">EDUCATION</a>
                      <h4 class="blogCard__title text-24 lh-15 text-dark-4 fw-500 mt-15">19 ways to optimize your ad marketing budget efficiently</h4>
                      <p class="blogCard__text mt-20">Our features, journey, tips and us being us. Lorem ipsum dolor sit amet, accumsan in, tempor dictum neque.</p>
                      <div class="blogCard__button d-inline-block mt-20">
                        <a href="#" class="button -sm -purple-3 text-purple-1">
                          Read More
            ...
            <div data-anim="slide-up delay-1" class="col-lg-10 col-md-11">
              <div class="blogCard -type-3">
                <div class="row y-gap-30 items-center">
                  <div class="col-lg-6">
                    <div class="blogCard__image">
                      <img class="rounded-8" src="{{ asset('template/img/blog-list/big/4.png') }}" alt="image">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-6">
                    <div class="blogCard__content pl-60 lg:pl-40 md:pl-0">
                      <a href="blog-single.html" class="blogCard__category text-14 lh-1 text-purple-1 fw-500">EDUCATION</a>
                      <h4 class="blogCard__title text-24 lh-15 text-dark-4 fw-500 mt-15">8 interesting programming languages you should be paying attention to</h4>
                      <p class="blogCard__text mt-20">Our features, journey, tips and us being us. Lorem ipsum dolor sit amet, accumsan in, tempor dictum neque.</p>
                      <div class="blogCard__button d-inline-block mt-20">
                        <a href="#" class="button -sm -purple-3 text-purple-1">
                          Read More
