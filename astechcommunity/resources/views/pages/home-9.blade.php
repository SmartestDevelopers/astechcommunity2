                ...
                <div>
                  ...
                  <div>
                    ...
                    <div class="sidebar__item -is-active">
                      <a href="{{ route('pages.about-1') }}" class="-dark-sidebar-white d-flex items-center text-17 lh-1 fw-500">
                        <i class="text-20 icon-discovery mr-15"></i>
                        Explore
                      </a>
                    </div>
                    ...
                    <div class="sidebar__item ">
                      <a href="{{ route('courses.list-1') }}" class="-dark-sidebar-white d-flex items-center text-17 lh-1 fw-500">
                        <i class="text-20 icon-play-button mr-15"></i>
                        Courses
                      </a>
                    </div>
            ...
            <div class="dashboard__content pt-0 px-15 pb-0">
              ...
              <section data-anim-wrap class="masthead -type-7 js-mouse-move-container">
                <div class="masthead__bg bg-purple-1 rounded-16">
                  <img src="{{ asset('template/img/home-9/hero/bg.png') }}" alt="image">
                </div>
                    ...
                    <div class="col-xl-5 col-lg-6">
                      <div class="masthead-image">
                        <div class="masthead-image__img1">
                          <img data-move="20" class="js-mouse-move" src="{{ asset('template/img/home-9/hero/1.png') }}" alt="image">
                        </div>

                        <div class="-el-1"><img class="js-mouse-move" data-move="40" src="{{ asset('template/img/home-9/hero/2.png') }}" alt="icon"></div>
                        <div class="-el-2"><img class="js-mouse-move" data-move="40" src="{{ asset('template/img/home-9/hero/3.png') }}" alt="icon"></div>
                        <div class="-el-3"><img class="js-mouse-move" data-move="40" src="{{ asset('template/img/home-9/hero/4.png') }}" alt="icon"></div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="pt-60 lg:pt-40">
                    <div class="overflow-hidden js-section-slider" data-loop data-gap="30" data-pagination data-slider-cols="xl-6 lg-6 md-4 sm-3 base-2">
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                          <div class="">
                            <img class="w-1/1" src="{{ asset('template/img/books/1.png') }}" alt="book">
                        ...
                        <div class="swiper-slide">
                          <div class="">
                            <img class="w-1/1" src="{{ asset('template/img/books/2.png') }}" alt="book">
                        ...
                        <div class="swiper-slide">
                          <div class="">
                            <img class="w-1/1" src="{{ asset('template/img/books/3.png') }}" alt="book">
                        ...
                        <div class="swiper-slide">
                          <div class="">
                            <img class="w-1/1" src="{{ asset('template/img/books/4.png') }}" alt="book">
                        ...
                        <div class="swiper-slide">
                          <div class="">
                            <img class="w-1/1" src="{{ asset('template/img/books/5.png') }}" alt="book">
                        ...
                        <div class="swiper-slide">
                          <div class="">
                            <img class="w-1/1" src="{{ asset('template/img/books/6.png') }}" alt="book">
                            <h5 class="text-17 fw-500 mt-15">HTML 5 Maker</h5>
                  ...
                  <div class="row y-gap-30 pt-60 lg:pt-40">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                      <div class="d-flex flex-column items-center">
                        <div>
                          <img src="{{ asset('template/img/streams/1.png') }}" alt="image">
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                      <div class="d-flex flex-column items-center">
                        <div>
                          <img src="{{ asset('template/img/streams/2.png') }}" alt="image">
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                      <div class="d-flex flex-column items-center">
                        <div>
                          <img src="{{ asset('template/img/streams/3.png') }}" alt="image">
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                      <div class="d-flex flex-column items-center">
                        <div>
                          <img src="{{ asset('template/img/streams/4.png') }}" alt="image">
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                      <div class="d-flex flex-column items-center">
                        <div>
                          <img src="{{ asset('template/img/streams/5.png') }}" alt="image">
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                      <div class="d-flex flex-column items-center">
                        <div>
                          <img src="{{ asset('template/img/streams/6.png') }}" alt="image">
                        </div>
              ...
              <section class="layout-pt-lg layout-pb-lg section-bg">
                <div class="section-bg__item">
                  <img class="img-full rounded-16" src="{{ asset('template/img/home-9/cta/bg.png') }}" alt="image">
                </div>
