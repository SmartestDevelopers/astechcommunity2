            ...
            <div class="row justify-center text-center">
              <div class="col-auto">
                <div data-anim="slide-up delay-1">
                  ...
                  <h1 class="page-header__title">UI Elements</h1>
      ...
      <section class="layout-pb-lg">
        <div class="container">
          <div class="row y-gap-50">
            <div class="col-lg-6">
              <div class="text-18 lh-1 text-dark-1 fw-500 mb-30">Accordions</div>
            ...
            <div class="col-lg-5">
              <div class="text-18 lh-1 text-dark-1 fw-500 mb-30">Tabs</div>
              <div class="tabs -pills js-tabs">
                <div class="tabs__controls d-flex x-gap-10 js-tabs-controls">

                  <div><button class="tabs__button px-20 py-8 rounded-8 text-light-1 js-tabs-button is-active" data-tab-target=".-tab-item-1" type="button">All Categories</button></div>

                  <div><button class="tabs__button px-20 py-8 rounded-8 text-light-1 js-tabs-button " data-tab-target=".-tab-item-2" type="button">Animation</button></div>

                  <div><button class="tabs__button px-20 py-8 rounded-8 text-light-1 js-tabs-button " data-tab-target=".-tab-item-3" type="button">Design</button></div>

                  <div><button class="tabs__button px-20 py-8 rounded-8 text-light-1 js-tabs-button " data-tab-target=".-tab-item-4" type="button">Illustration</button></div>
              ...
              <div class="tabs -active-purple-2 mt-30 js-tabs">
                <div class="tabs__controls d-flex items-center js-tabs-controls">

                  <div><button class="text-light-1 lh-12 tabs__button mr-30 js-tabs-button is-active" data-tab-target=".-tab-item-1" type="button">items 1</button></div>

                  <div><button class="text-light-1 lh-12 tabs__button mr-30 js-tabs-button " data-tab-target=".-tab-item-2" type="button">items 2</button></div>

                  <div><button class="text-light-1 lh-12 tabs__button mr-30 js-tabs-button " data-tab-target=".-tab-item-3" type="button">items 3</button></div>
            ...
            <div class="col-lg-6">
              <div class="text-18 lh-1 text-dark-1 fw-500 mb-30">Message Boxes</div>
              ...
              <div class="row y-gap-20">
                ...
                <div class="col-12">
                  <div class="d-flex items-center justify-between bg-info-1 pl-30 pr-20 py-30 rounded-8">
                    ...
                    <div class="text-info-2 size-20" data-feather="x"></div>
                  </div>
                </div>
          ...
          <div class="row y-gap-30 pt-50">
            ...
            <div class="col-auto">
              <div class="row x-gap-10 y-gap-10">
                ...
                <div class="col-auto">
                  <button class="button -md -outline-purple-1 text-purple-1">Button 1 Hover</button>
                </div>
              </div>
            </div>
            ...
            <div class="col-auto">
              <div class="row x-gap-10 y-gap-10">
                ...
                <div class="col-auto">
                  <button class="button -md -outline-green-1 text-green-1">Button 2 Hover</button>
                </div>
              </div>
            </div>
            ...
            <div class="col-auto">
              <div class="row x-gap-10 y-gap-10">
                ...
                <div class="col-auto">
                  <button class="button -md -outline-dark-1 text-dark-1">Button 3 Hover</button>
                </div>
              </div>
            </div>
            ...
            <div class="col-auto">
              <div class="row x-gap-10 y-gap-10">
                ...
                <div class="col-auto">
                  <button class="button -md -purple-1 text-white">Button 4 Hover</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row y-gap pt-30">
            ...
            <div class="col-auto">
              ...
              <a href="instructors-list-1.html" class="button -icon -purple-1 text-white">
                View All Instructors
                <i class="icon-arrow-top-right text-13 ml-10"></i>
              </a>
            ...
            <div class="col-auto">
              ...
              <a href="instructors-list-1.html" class="button -icon -outline-purple-1 text-purple-1">
                View All Instructors
                <i class="icon-arrow-top-right text-13 ml-10"></i>
              </a>
          ...
          <div class="row x-gap-60 y-gap-30 mt-50">
            <div class="col-12">
              <div class="text-18 lh-1 text-dark-1 fw-500">Form</div>
            </div>

            <div class="col-lg-6">
              <form class="contact-form">
                <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Input</label>
              ...
              <label class="text-16 lh-1 fw-500 text-dark-1 mb-10 mt-30">Select boxes</label>
              ...
              <div class="select js-select js-liveSearch" data-select-value="">
                ...
                <div class="select__dropdown js-dropdown">
                  ...
                  <select class="select__select js-select-tag" name="name" multiple>
            ...
            <div class="col-lg-6">
              <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Multiple Select Boxes, Hover</label>
              ...
              <div class="select js-multiple-select" data-select-value="">
                ...
                <div class="select__dropdown js-dropdown">
                  <div class="select__options js-options">
                    ...
                    <div class="select__options__button js-target-title" data-value="banking">
                      ...
                      <span class="ml-10">Banking</span>
                    </div>

                    <div class="select__options__button js-target-title" data-value="digital &amp; creative">
                      <div class="form-checkbox pointer-events-none">
                        <input type="checkbox">
                        <div class="form-checkbox__mark">
                          <div class="form-checkbox__icon icon-check"></div>
                      ...
                      <span class="ml-10">Digital &amp; Creative</span>
                    </div>

                    <div class="select__options__button js-target-title" data-value="retail">
                      <div class="form-checkbox pointer-events-none">
                        <input type="checkbox">
                        <div class="form-checkbox__mark">
                          <div class="form-checkbox__icon icon-check"></div>
                      ...
                      <span class="ml-10">Retail</span>
                    </div>

                    <div class="select__options__button js-target-title" data-value="designer">
                      <div class="form-checkbox pointer-events-none">
                        <input type="checkbox">
                        <div class="form-checkbox__mark">
                          <div class="form-checkbox__icon icon-check"></div>
                      ...
                      <span class="ml-10">Designer</span>
                    </div>

                    <div class="select__options__button js-target-title" data-value="developer">
                      <div class="form-checkbox pointer-events-none">
                        <input type="checkbox">
                        <div class="form-checkbox__mark">
                          <div class="form-checkbox__icon icon-check"></div>
                      ...
                      <span class="ml-10">Developer</span>
                    </div>

                  </div>

                  <select class="select__select js-select-tag" name="name2" multiple="multiple">
                    <option value="banking">Banking</option>
                    <option value="digital & creative">Digital & Creative</option>
                    <option value="retail">Retail</option>
                    <option value="designer">Designer</option>
            ...
            <div class="col-lg-6">
              <form action="https://creativelayers.net/themes/educrat-html/post" class="contact-form">
              ...
              <div class="row">
                  ...
                  <div class="row y-gap-15">
                    <div class="col-12">
                      <div class="form-radio d-flex items-center ">
                        ...
                        <div class="lh-1 text-14 text-dark-1 ml-12">items</div>
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-radio d-flex items-center ">
                ...
                <div class="col-md-4">
                  ...
                  <div class="d-flex items-center">
                    ...
                    <div class="text-14 lh-12 text-dark-1 ml-15">Items</div>
                  </div>
          ...
          <div class="row y-gap-30 justify-between mt-50">
            <div class="col-xl-3 col-lg-4">
              <div class="text-18 lh-1 text-dark-1 fw-500 mb-30">Tooltips</div>
              <div class="d-flex mt-24">
                <div class="tooltip -top px-35 py-15 bg-light-3 rounded-8">
                  Top
                  <div class="tooltip__content">Top</div>
                </div>
                <div class="tooltip -bottom px-35 py-15 bg-light-3 rounded-8 ml-12">
                  Bottom
                  <div class="tooltip__content">Bottom</div>
                </div>
                <div class="tooltip -left px-35 py-15 bg-light-3 rounded-8 ml-12">
                  Left
                  <div class="tooltip__content">Left</div>
                </div>
                <div class="tooltip -right px-35 py-15 bg-light-3 rounded-8 ml-12">
                  Right
                  <div class="tooltip__content">Right</div>
                </div>
              </div>

              <div class="text-18 lh-1 text-dark-1 fw-500 mb-30 mt-60">Range Slider</div>
              ...
              <div class="js-price-rangeSlider">
                ...
                <div class="d-flex justify-center mt-15">
                  <div class="d-flex items-center h-30 px-15 rounded-4 bg-purple-3 text-14 text-purple-1">
            ...
            <div class="col-lg-6">
              <div class="text-18 lh-1 text-dark-1 fw-500 mb-30">Progress bars</div>
              <div class="progress-bar">
                <div class="progress-bar__bg bg-light-3"></div>
                <div class="progress-bar__bar bg-purple-1 col-10">
                  <span>90%</span>
                </div>
              </div>
              <div class="progress-bar mt-50">
                <div class="progress-bar__bg bg-light-3"></div>
                <div class="progress-bar__bar bg-purple-1 col-6">
                  <span>50%</span>
                </div>
              </div>
              <div class="progress-bar mt-50">
                <div class="progress-bar__bg bg-light-3"></div>
                <div class="progress-bar__bar bg-purple-1 col-5">
                  <span>40%</span>
                </div>
              </div>
            </div>
          ...
          <div class="row pt-60 lg:pt-40">
            <div class="col-12">
              <div class="text-18 lh-1 text-dark-1 fw-500 mb-30">Typography</div>
          ...
          <div class="row pt-60 lg:pt-40">
            <div class="col-lg-9">
              <div class="text-18 lh-1 text-dark-1 fw-500 mb-30">What you'll learn</div>
          ...
          <div class="row pt-60 lg:pt-40">
            <div class="col-12">
              <div class="text-18 lh-1 text-dark-1 fw-500 mb-30">Requirements</div>
              <ul class="ul-list y-gap-15">
