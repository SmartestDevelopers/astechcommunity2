            ...
            <div class="col-lg-9">
              ...
              <div class="row y-gap-30">
                ...
                <div class="col-lg-4 col-md-6">
                  <div data-anim-child="slide-left delay-2" class="teamCard -type-1 px-10 py-10 rounded-8 border-light">
                ...
                <div class="col-lg-4 col-md-6">
                  <div data-anim-child="slide-left delay-3" class="teamCard -type-1 px-10 py-10 rounded-8 border-light">
                    <div class="teamCard__image">
                ...
                <div class="col-lg-4 col-md-6">
                  <div data-anim-child="slide-left delay-4" class="teamCard -type-1 px-10 py-10 rounded-8 border-light">
                    <div class="teamCard__image">
                ...
                <div class="col-lg-4 col-md-6">
                  <div data-anim-child="slide-left delay-5" class="teamCard -type-1 px-10 py-10 rounded-8 border-light">
                    <div class="teamCard__image">
                ...
                <div class="col-lg-4 col-md-6">
                  <div data-anim-child="slide-left delay-6" class="teamCard -type-1 px-10 py-10 rounded-8 border-light">
                    <div class="teamCard__image">
                      <img src="{{ asset('template/img/team/5.png') }}" alt="image">
                    </div>
                    <div class="teamCard__content mt-10 px-10 pb-5">
                ...
                <div class="col-lg-4 col-md-6">
                  <div data-anim-child="slide-left delay-7" class="teamCard -type-1 px-10 py-10 rounded-8 border-light">
                    <div class="teamCard__image">
                      <img src="{{ asset('template/img/team/6.png') }}" alt="image">
                    </div>
                    <div class="teamCard__content mt-10 px-10 pb-5">
