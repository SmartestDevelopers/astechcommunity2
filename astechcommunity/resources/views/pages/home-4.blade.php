          ...
          <div class="col-auto">
            <div class="header-right d-flex items-center">
              ...
              <div class="header-right__buttons d-flex items-center lg:d-none">
                <a href="#" class="button -underline text-dark-1 -before-border py-3 pl-30 xl:pl-20">Log in</a>
                <a href="#" class="button h-50 px-25 -purple-3 -rounded text-purple-1 ml-20">Sign up</a>
              </div>
            </div>
          </div>
    ...
    <div class="content-wrapper  js-content-wrapper">
            ...
            <div class="col-xl-7 col-lg-11 relative z-5">
              <div class="masthead__content pl-32 lg:pl-0">
                <h1 data-anim-child="slide-up delay-1" class="masthead__title">
                  Find Your Preferred<br> <span class="text-purple-1">Courses</span> & Improve Your Skills
                </h1>

                <p data-anim-child="slide-up delay-2" class="masthead__text text-17 text-dark-1 mt-25">
                  Build skills with courses, certificates, and degrees online from<br class="lg:d-none">
              ...
              <div class="masthead-image">
                <div class="masthead-image__img1">
                  <div class="masthead-image__shape xl:d-none">
                    <img src="{{ asset('template/img/home-4/masthead/shape.svg') }}" alt="image">
                  </div>
                  <img data-move="20" class="js-mouse-move" src="{{ asset('template/img/home-4/masthead/1.png') }}" alt="image">
                </div>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-up delay-1">
                  ...
                  <a href="{{ route('courses.single-1') }}" class="coursesCard -type-1 shadow-3 rounded-8 bg-white">
                    <div class="relative">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="coursesCard -type-3 text-center">
                <div class="coursesCard__icon bg-green-3">
                  <img src="{{ asset('template/img/home-4/learning/1.svg') }}" alt="icon">
                </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="coursesCard -type-3 text-center">
                <div class="coursesCard__icon bg-yellow-2">
                  <img src="{{ asset('template/img/home-4/learning/2.svg') }}" alt="icon">
                </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="coursesCard -type-3 text-center">
                <div class="coursesCard__icon bg-blue-2">
                  <img src="{{ asset('template/img/home-4/learning/3.svg') }}" alt="icon">
                </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="coursesCard -type-3 text-center">
                <div class="coursesCard__icon bg-orange-3">
                  <img src="{{ asset('template/img/home-4/learning/4.svg') }}" alt="icon">
                </div>
          ...
          <div class="row y-gap-50 justify-between items-center">
            <div class="col-xl-3 col-lg-4">
              ...
              <div class="sectionTitle -light">
                ...
                <h2 class="sectionTitle__title ">Featured Courses</h2>

                <p class="sectionTitle__text ">Hand-picked Instructor and expertly crafted courses, designed for the modern students and entrepreneur.</p>

              </div>


              <div class="d-inline-block mt-60 lg:mt-25">
                    ...
                    <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                      ...
                      <div>
                        <div class="px-15 rounded-200 bg-orange-1">
                          <span class="text-11 lh-1 uppercase fw-500 text-white">New</span>
                        </div>
                      </div>
        ...
        <div class="container">
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-xl-5 col-lg-6 col-md-9 lg:order-2">
              <h3 class="text-40 lh-1">Land your dream job in data science</h3>
              <p class="mt-25">From a certification in data science to personalized resume reviews and interview prep—we've got you covered.</p>
              <div class="d-inline-block mt-30">
                <a href="#" class="button -md -outline-purple-1 text-purple-1">Learn More</a>
              </div>
            </div>

            <div class="col-lg-6 lg:order-1">
              <img class="w-1/1" src="{{ asset('template/img/home-4/dreamJob/1.png') }}" alt="image">
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row justify-center text-center">
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <h2 class="sectionTitle__title text-white">People Say About Educrat</h2>
                  ...
                  <div class="row y-gap-30 md:text-center md:justify-center">
                    <div class="col-md-auto">
                      <div class="testimonials__image">
                        <img src="{{ asset('template/img/home-4/testimonials/1.png') }}" alt="image">
                      </div>
                    </div>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-2" class="testimonials -type-3 sm:px-20 sm:py-40 bg-white">
                  <div class="row y-gap-30 md:text-center md:justify-center">
                    <div class="col-md-auto">
                      <div class="testimonials__image">
                        <img src="{{ asset('template/img/home-4/testimonials/2.png') }}" alt="image">
                      </div>
                    </div>
              ...
              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-3" class="testimonials -type-3 sm:px-20 sm:py-40 bg-white">
                  <div class="row y-gap-30 md:text-center md:justify-center">
                    <div class="col-md-auto">
                      <div class="testimonials__image">
                        <img src="{{ asset('template/img/home-4/testimonials/3.png') }}" alt="image">
                      </div>
                    </div>
      ...
      <section class="layout-pt-lg layout-pb-lg">
        <div class="container">
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-lg-6">
              <img class="w-1/1" src="{{ asset('template/img/home-4/dreamJob/2.png') }}" alt="image">
            </div>

            <div class="col-xl-5 col-lg-6 col-md-9">
              <h3 class="text-30 lh-15">Courses taught by industry<br class="lg:d-none"> leaders around the world</h3>
              <p class="mt-30">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
              <div class="d-flex x-gap-15 y-gap-15 pt-30">
                <div>
                  <a href="#" class="button -md -purple-1 text-white">Start Teaching Today</a>
                </div>
                <div>
                  <a href="#" class="button -md -outline-dark-1 text-dark-1">Browse Teacher</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="eventCard -type-3 bg-light-4 rounded-8">
                  ...
                  <h4 class="eventCard__title text-24 lh-15 fw-500">Educational technology and mobile learning</h4>
              ...
              <div class="swiper-slide">
                <div class="eventCard -type-3 bg-light-4 rounded-8">
                  ...
                  <h4 class="eventCard__title text-24 lh-15 fw-500">We are changing the way the world learns</h4>
              ...
              <div class="swiper-slide">
                <div class="eventCard -type-3 bg-light-4 rounded-8">
                  ...
                  <h4 class="eventCard__title text-24 lh-15 fw-500">Guide to visas and funding to study in the UK</h4>
              ...
              <div class="swiper-slide">
                <div class="eventCard -type-3 bg-light-4 rounded-8">
                  ...
                  <h4 class="eventCard__title text-24 lh-15 fw-500">Achieving Advanced in Insights with Big</h4>
      ...
      <section class="layout-pt-lg layout-pb-lg border-top-light">
        <div data-anim-wrap class="container">
          <div class="row justify-center text-center">
            <div class="col-auto">
              ...
              <div class="sectionTitle ">
                ...
                <h2 class="sectionTitle__title ">Get personal learning recommendations</h2>

                <p class="sectionTitle__text ">Enhance your skills with best Online courses</p>
          ...
          <div class="row y-gap-20 justify-center pt-30">
            <div class="col-auto">
              <div class="dropdown js-dropdown js-catb-active">
                <div class="dropdown__button d-flex items-center text-14 border-light h-60" data-el-toggle=".js-catb-toggle" data-el-toggle-active=".js-catb-active">
            ...
            <div class="col-auto">
              <div class="dropdown js-dropdown js-diff-active">
                <div class="dropdown__button d-flex items-center text-14 border-light h-60" data-el-toggle=".js-diff-toggle" data-el-toggle-active=".js-diff-active">
