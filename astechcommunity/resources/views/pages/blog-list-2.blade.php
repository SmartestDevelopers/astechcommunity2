            ...
            <div class="col-lg-9">
              <div class="row y-gap-30">
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-4 col-md-6">
                  <a href="blog-single.html" class="blogCard -type-1">
                    <div class="blogCard__image">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/blog-list/1.png') }}" alt="image">
                    </div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-4 col-md-6">
                  <a href="blog-single.html" class="blogCard -type-1">
                    <div class="blogCard__image">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/blog-list/2.png') }}" alt="image">
                    </div>
                    <div class="blogCard__content mt-20">
                      <div class="blogCard__category">EDUCATION</div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-4 col-md-6">
                  <a href="blog-single.html" class="blogCard -type-1">
                    <div class="blogCard__image">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/blog-list/3.png') }}" alt="image">
                    </div>
                    <div class="blogCard__content mt-20">
                      <div class="blogCard__category">EDUCATION</div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-4 col-md-6">
                  <a href="blog-single.html" class="blogCard -type-1">
                    <div class="blogCard__image">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/blog-list/4.png') }}" alt="image">
                    </div>
                    <div class="blogCard__content mt-20">
                      <div class="blogCard__category">EDUCATION</div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-4 col-md-6">
                  <a href="blog-single.html" class="blogCard -type-1">
                    <div class="blogCard__image">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/blog-list/5.png') }}" alt="image">
                    </div>
                    <div class="blogCard__content mt-20">
                      <div class="blogCard__category">EDUCATION</div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-4 col-md-6">
                  <a href="blog-single.html" class="blogCard -type-1">
                    <div class="blogCard__image">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/blog-list/6.png') }}" alt="image">
                    </div>
                    <div class="blogCard__content mt-20">
                      <div class="blogCard__category">EDUCATION</div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-4 col-md-6">
                  <a href="blog-single.html" class="blogCard -type-1">
                    <div class="blogCard__image">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/blog-list/7.png') }}" alt="image">
                    </div>
                    <div class="blogCard__content mt-20">
                      <div class="blogCard__category">EDUCATION</div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-4 col-md-6">
                  <a href="blog-single.html" class="blogCard -type-1">
                    <div class="blogCard__image">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/blog-list/8.png') }}" alt="image">
                    </div>
                    <div class="blogCard__content mt-20">
                      <div class="blogCard__category">EDUCATION</div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-4 col-md-6">
                  <a href="blog-single.html" class="blogCard -type-1">
                    <div class="blogCard__image">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/blog-list/9.png') }}" alt="image">
                    </div>
                    <div class="blogCard__content mt-20">
                      <div class="blogCard__category">EDUCATION</div>
