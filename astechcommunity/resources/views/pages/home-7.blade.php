          ...
          <div class="col-auto">
            <div class="header-right d-flex items-center">
              ...
              <div class="header-right__buttons d-flex items-center ml-30 xl:ml-20 lg:d-none">
                ...
                <a href="{{ route('register') }}" class="button h-50 px-30 -purple-3 -rounded text-purple-1 ml-15">Sign up</a>
              </div>
            </div>
          </div>
    ...
    <div class="content-wrapper  js-content-wrapper">
      ...
      <section data-anim-wrap class="masthead -type-6">
        <div class="masthead__bg">
          <img src="{{ asset('template/img/home-7/hero/1.svg') }}" alt="blob">
          <img src="{{ asset('template/img/home-7/hero/2.svg') }}" alt="blob">
          <img src="{{ asset('template/img/home-7/hero/bg.png') }}" alt="background">
          ...
          <div class="row y-gap-50 items-center">
            <div class="col-lg-5">
              <div class="masthead__content">
                ...
                <h1 data-anim-child="slide-up delay-3" class="masthead__title">
                  ...
                  <span class="text-purple-1">online</span>
                </h1>
                <p data-anim-child="slide-up delay-4" class="mt-5">
                  Data drives everything. Get the skills you need<br class="lg:d-none">
                  for the future of work.
                </p>
                <div data-anim-child="slide-up delay-5" class="row items-center x-gap-20 y-gap-20 pt-20">
                  <div class="col-auto">
                    <a href="{{ route('register') }}" class="button -md -gradient-1 -rounded text-white">Join For Free</a>
                  </div>
                  <div class="col-auto">
                    <a href="{{ route('courses.list-1') }}" class="button -md -outline-light-5 -rounded text-dark-1">Find Courses</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-7">
              <div data-anim-child="slide-up delay-6" class="masthead__image relative">
                <img src="{{ asset('template/img/home-7/hero/image.png') }}" alt="image">
          ...
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-lg-6">
              <div class="composition -type-4">
                <div class="-el-1">
                  <img class="w-1/1" src="{{ asset('template/img/home-7/courses/1.png') }}" alt="image">
                </div>
                ...
                <div class="-el-2">
                  <div class="px-40 py-40 sm:px-25 sm:py-25 bg-white shadow-4 rounded-8">
                    ...
                    <div class="text-18 lh-18 text-dark-1 fw-500 mt-30">“Teaching on Education platform has been an amazing experience”</div>
                    <div class="mt-30">
                      <div class="text-15 lh-12 text-dark-1 fw-500">Ali Tufan</div>
                      <div class="text-14 lh-12 mt-5">Designer, Apple Inc</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-5 col-lg-6 col-md-9">
              <h3 class="text-45 md:text-30 lh-11"><span class="text-purple-1">Courses</span> taught by industry leaders around the world</h3>
              <p class="mt-25">Use the list below to bring attention to your product’s key<br class="lg:d-none"> differentiator.</p>
              <div class="d-flex x-gap-15 y-gap-15 flex-wrap pt-30">
                <div>
                  <a href="#" class="button -md -dark-1 text-white">Browse Teacher</a>
                </div>
                <div>
                  <a href="#" class="button -md -outline-dark-1 text-dark-1">Become a Teacher</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row y-gap-20 justify-between items-center">
            <div class="col-xl-4 col-lg-5">
              <h2 class="text-30 lh-15 text-white">Finding Your Right Courses</h2>
              <p class="text-white mt-10">Use the list below to bring attention to your product’s key differentiator.</p>
            </div>

            <div class="col-auto">
              <a href="{{ route('courses.list-1') }}" class="button -md -white text-dark-1">Get Started</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div data-anim-wrap class="row y-gap-30 justify-between items-center">
            <div class="col-xl-5 col-lg-6 order-2 order-lg-1">
              <h2 data-anim-child="slide-up delay-1" class="text-45 lg:text-40 md:text-30 text-dark-1">How it <span class="text-purple-1">Works</span></h2>
              <p data-anim-child="slide-up delay-2" class="text-dark-1 mt-20">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed di nonumy eirmod tempor invidunt ut labore et dolore magn aliq erat.</p>
              ...
              <div data-anim-child="slide-up delay-3" class="row y-gap-30 pt-60 lg:pt-40">
                ...
                <div class="col-12">
                  <div class="featureIcon -type-1">
                    <div class="featureIcon__icon bg-light-7">
                      <img src="{{ asset('template/img/home-7/about/icons/1.svg') }}" alt="icon">
                    </div>
                    <div class="featureIcon__content ml-30 md:ml-20">
                      <h4 class="text-17 fw-500">Create Account</h4>
                ...
                <div class="col-12">
                  <div class="featureIcon -type-1">
                    <div class="featureIcon__icon bg-light-7">
                      <img src="{{ asset('template/img/home-7/about/icons/2.svg') }}" alt="icon">
                    </div>
                    <div class="featureIcon__content ml-30 md:ml-20">
                      <h4 class="text-17 fw-500">Select Courses</h4>
                      <p class="mt-5">Lorem ipsum is placeholder text commonly used<br class="lg:d-none"> in the graphic, print, and publishing industries</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="featureIcon -type-1">
                    <div class="featureIcon__icon bg-light-7">
                      <img src="{{ asset('template/img/home-7/about/icons/3.svg') }}" alt="icon">
                    </div>
                    <div class="featureIcon__content ml-30 md:ml-20">
                      <h4 class="text-17 fw-500">Enjoy Your Courses</h4>
                      <p class="mt-5">Lorem ipsum is placeholder text commonly used<br class="lg:d-none"> in the graphic, print, and publishing industries</p>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-6 order-1 order-lg-2">
              <div class="composition -type-5">
                <div class="-el-1">
                  <img src="{{ asset('template/img/home-7/about/1.png') }}" alt="image">
                </div>

                <div class="-el-2">
                  <img src="{{ asset('template/img/home-7/about/2.png') }}" alt="image">
                </div>
          ...
          <div class="row y-gap-30 pt-60">
            ...
            <div class="col-lg-3 col-md-6">
              <div data-anim-child="slide-left delay-2" class="blogCard -type-1 rounded-8 border-light shadow-1 overflow-hidden">
                <div class="blogCard__image ratio ratio-3:2">
                  <img class="img-ratio" src="{{ asset('template/img/home-3/blog/1.png') }}" alt="image">
                </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div data-anim-child="slide-left delay-3" class="blogCard -type-1 rounded-8 border-light shadow-1 overflow-hidden">
                <div class="blogCard__image ratio ratio-3:2">
                  <img class="img-ratio" src="{{ asset('template/img/home-3/blog/2.png') }}" alt="image">
                </div>
                <div class="px-30 py-30 bg-white">
                  <a href="#" class="d-flex items-center text-14 lh-1 text-light-1 mb-15">
                    <div class="icon-calendar-2"></div>
            ...
            <div class="col-lg-3 col-md-6">
              <div data-anim-child="slide-left delay-4" class="blogCard -type-1 rounded-8 border-light shadow-1 overflow-hidden">
                <div class="blogCard__image ratio ratio-3:2">
                  <img class="img-ratio" src="{{ asset('template/img/home-3/blog/3.png') }}" alt="image">
                </div>
                <div class="px-30 py-30 bg-white">
                  <a href="#" class="d-flex items-center text-14 lh-1 text-light-1 mb-15">
                    <div class="icon-calendar-2"></div>
            ...
            <div class="col-lg-3 col-md-6">
              <div data-anim-child="slide-left delay-5" class="blogCard -type-1 rounded-8 border-light shadow-1 overflow-hidden">
                <div class="blogCard__image ratio ratio-3:2">
                  <img class="img-ratio" src="{{ asset('template/img/home-3/blog/4.png') }}" alt="image">
                </div>
                <div class="px-30 py-30 bg-white">
                  <a href="#" class="d-flex items-center text-14 lh-1 text-light-1 mb-15">
                    <div class="icon-calendar-2"></div>
              ...
              <div class="priceCard -type-1 rounded-16 bg-white shadow-2">
                <div class="priceCard__content py-45 px-60 xl:px-40 text-center">
                  ...
                  <div class="d-inline-block mt-30">
                    <a class="button px-40 py-20 fw-500 -purple-3 text-purple-1" href="{{ route('courses.list-1') }}">Get Started Now</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row justify-center text-center">
            <div class="col-xl-6 col-lg-8 col-md-10">
              ...
              <div class="sectionTitle ">
                ...
                <p class="sectionTitle__text ">Certificate courses are instructed by highly educated and qualified instructors who hold doctoral and master’s level degrees.</p>
      ...
      <section class="layout-pt-lg layout-pb-lg">
        <div class="container">
          ...
          <div class="row x-gap-50 y-gap-30 justify-between pt-60 lg:pt-40">
            ...
            <div class="col-lg-2">
              <h4 class="text-17 fw-500">Creative</h4>
              ...
              <a href="#" class="d-block underline text-purple-1 fw-500 mt-15">More</a>
            </div>

            <div class="col-lg-2">
              <h4 class="text-17 fw-500">Business</h4>
              <div class="y-gap-5 pt-15">
                <div class="">Animation</div>
                <div class="">Drawing</div>
                <div class="">Graphic Design</div>
      ...
      <footer class="footer -type-4 bg-white border-top-light">
        <div class="container">
          <div class="row y-gap-30 justify-between pt-60">
            <div class="col-lg-7 col-md-6">
              ...
              <form action="https://creativelayers.net/themes/educrat-html/post" class="form-single-field -base mt-15">
                <input class="py-20 px-30 bg-light-3 rounded-200 text-dark-1" type="text" placeholder="Your Email">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6">
              ...
              <div class="d-flex justify-between mt-30">
                <div class="">
                  ...
                  <div class="text-18 lh-1 fw-500 text-dark-1 mt-5">+(1) 123 456 7890</div>
                </div>
                <div class="">
                  <div class="">Need live support?</div>
                  <div class="text-18 lh-1 fw-500 text-dark-1 mt-5">hi@educrat.comv</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row y-gap-30 justify-between pt-60 pb-60">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6">
              <div class="">
                <div class="text-17 uppercase text-whitedark-1 fw-500">Take your learning with you</div>
                <div class="d-flex mt-15">
                  <a href="#"><img src="{{ asset('template/img/footer/apps-2/1.png') }}" alt="image"></a>
                  <a href="#" class="ml-10"><img src="{{ asset('template/img/footer/apps-2/2.png') }}" alt="image"></a>
                </div>
              </div>

              <div class="footer-header-socials mt-60">
                <div class="text-17 uppercase text-dark-1 fw-500">Follow us on social media</div>
