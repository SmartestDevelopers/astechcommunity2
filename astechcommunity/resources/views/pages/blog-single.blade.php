              ...
              <div class="row justify-center">
                <div class="col-xl-8 col-lg-9 col-md-11">
                  ...
                  <div class="row y-gap-30 pt-30">
                    <div class="col-sm-6">
                      <img src="{{ asset('template/img/blog/blog-single/1.png') }}" alt="image" class="w-1/1 initial-img rounded-8">
                    </div>
                    <div class="col-sm-6">
                      <img src="{{ asset('template/img/blog/blog-single/2.png') }}" alt="image" class="w-1/1 initial-img rounded-8">
                    </div>
                  </div>
