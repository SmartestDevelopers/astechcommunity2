      ...
      <div class="header__container">
        <div class="row justify-between items-center">
          ...
          <div class="col-auto lg:d-none">
            <div class="text-20 lh-1 text-white fw-500">The Ultimate Drawing Course Beginner to Advanced</div>
          </div>
          ...
          <div class="row justify-end">
            <div class="col-xxl-8 col-xl-7 col-lg-8">
              <div class="relative pt-40">
                <img class="w-1/1 rounded-16" src="{{ asset('template/img/lesson-single/1.png') }}" alt="image">
