            ...
            <div class="header-left d-flex items-center">
              ...
              <div class="header__logo pr-30 xl:pr-20 md:pr-0">
                <a data-barba href="{{ route('home') }}">
                  <img src="{{ asset('template/img/general/logo-black.svg') }}" alt="logo">
                </a>
              </div>
          ...
          <div class="col-auto">
            <div class="header-right d-flex items-center">
              ...
              <div class="header-right__buttons d-flex items-center ml-30 xl:ml-20 lg:d-none">
                ...
                <a href="{{ route('register') }}" class="button h-50 px-40 -purple-1 -rounded text-white ml-30 xl:ml-20">Sign up</a>
              </div>
            </div>
          </div>
    ...
    <div class="content-wrapper  js-content-wrapper">
      ...
      <section data-anim-wrap class="masthead -type-5">
        <div class="masthead__bg pr-60 md:pr-0">
          <img src="{{ asset('template/img/home-6/hero/bg.png') }}" alt="image">
        </div>
          ...
          <div class="row y-gap-50 items-center justify-between">
            <div class="col-lg-6">
              <div class="masthead__content">
                <h1 data-anim-child="slide-up delay-1" class="masthead__title">
                  More Than <span class="text-purple-1 underline">3.500+</span><br class="md:d-none">
                  Education Courses<br class="md:d-none">
                  Online Join Us Today
                </h1>

                <div data-anim-child="slide-up delay-2" class="row items-center x-gap-30 y-gap-20 pt-30">
                  <div class="col-auto">
                    <a href="{{ route('courses.list-1') }}" class="button -md -dark-1 -rounded text-white">Get Started</a>
                  </div>
                  ...
                  <div class="col-auto">
                    <a href="https://www.youtube.com/watch?v=ANYfx4-jyqY" class="d-flex items-center js-gallery" data-gallery="gallery1">
                      ...
                      <div class="ml-10">Watch Video</div>
                    </a>
                  </div>
                </div>
                ...
                <div data-anim-child="slide-up delay-3" class="row x-gap-20 y-gap-20 items-center pt-60 lg:pt-30">
                  ...
                  <div class="col-xl-4">
                    <div class="d-flex items-center text-dark-1">
                      <div class="mr-10">
                        <img src="{{ asset('template/img/home-6/hero/icons/1.svg') }}" alt="icon">
                      </div>
                  ...
                  <div class="col-xl-4">
                    <div class="d-flex items-center text-dark-1">
                      <div class="mr-10">
                        <img src="{{ asset('template/img/home-6/hero/icons/2.svg') }}" alt="icon">
                      </div>
                  ...
                  <div class="col-xl-4">
                    <div class="d-flex items-center text-dark-1">
                      <div class="mr-10">
                        <img src="{{ asset('template/img/home-6/hero/icons/3.svg') }}" alt="icon">
                      </div>
                      <div class="fw-500 lh-1 pt-3">Learn anything online</div>
                    </div>
                  </div>
            ...
            <div class="col-lg-6">
              <div class="composition -type-1 js-mouse-move-container">
                <div class="-img-1">
                  <img class="js-mouse-move" data-move="40" src="{{ asset('template/img/home-6/hero/2.png') }}" alt="image">
                </div>
                <div class="-img-2">
                  <img class="js-mouse-move" data-move="40" src="{{ asset('template/img/home-6/hero/1.png') }}" alt="image">
                </div>
                <div class="-img-3">
                  <img class="js-mouse-move" data-move="40" src="{{ asset('template/img/home-6/hero/3.png') }}" alt="image">
                </div>
        ...
        <div data-anim-wrap class="container">
          ...
          <div class="row y-gap-30 justify-between pt-60 lg:pt-50">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="coursesCard -type-3 px-0 text-center">
                <div class="coursesCard__icon bg-white shadow-2">
                  <i class="icon icon-rating-2 text-dark-1"></i>
                </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="coursesCard -type-3 px-0 text-center">
                <div class="coursesCard__icon bg-white shadow-2">
                  <i class="icon icon-online-learning-3 text-dark-1"></i>
                </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="coursesCard -type-3 px-0 text-center">
                <div class="coursesCard__icon bg-white shadow-2">
                  <i class="icon icon-online-learning-2 text-dark-1"></i>
                </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="coursesCard -type-3 px-0 text-center">
                <div class="coursesCard__icon bg-white shadow-2">
                  <i class="icon icon-access text-dark-1"></i>
                </div>
      ...
      <section class="layout-pt-md layout-pb-lg">
        <div data-anim-wrap class="container tabs -pills-2 js-tabs">
          <div class="row y-gap-20 justify-between items-end">
            ...
            <div class="col-auto">
              <div class="tabs__controls row justify-center x-gap-10 bg-light-3 rounded-200 py-5 js-tabs-controls">

                <div class="col-auto">
                  <button class="tabs__button px-20 py-8 rounded-200 fw-500 js-tabs-button is-active" data-tab-target=".-tab-item-1" type="button">All Categories</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button px-20 py-8 rounded-200 fw-500 js-tabs-button " data-tab-target=".-tab-item-2" type="button">Design</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button px-20 py-8 rounded-200 fw-500 js-tabs-button " data-tab-target=".-tab-item-3" type="button">Development</button>
                </div>

                <div class="col-auto">
                  <button class="tabs__button px-20 py-8 rounded-200 fw-500 js-tabs-button " data-tab-target=".-tab-item-4" type="button">Animation</button>
                </div>
            ...
            <div class="tabs__pane -tab-item-1 is-active">
              <div class="row y-gap-30 justify-center">
                ...
                <div data-anim-child="slide-up delay-1" class="col-lg-6">
                  <a href="#" class="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                    <div class="coursesCard__image max-w-250 rounded-8">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/coursesCards/1.png') }}" alt="image">
                    </div>

                    <div class="coursesCard__content pl-20 sm:pl-10 pr-10">
                      <div class="coursesCard__stars">
                        <img src="{{ asset('template/img/coursesCards/icons/review.svg') }}" alt="review">
                      ...
                      <div class="d-flex justify-between items-center pt-10 border-top-light">
                        ...
                        <div class="d-flex items-center">
                          <div class="fw-500 mr-10 line-through text-light-1">$179</div>
                ...
                <div data-anim-child="slide-up delay-2" class="col-lg-6">
                  <a href="#" class="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                    <div class="coursesCard__image max-w-250 rounded-8">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/coursesCards/2.png') }}" alt="image">
                    </div>
                ...
                <div data-anim-child="slide-up delay-3" class="col-lg-6">
                  <a href="#" class="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                    <div class="coursesCard__image max-w-250 rounded-8">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/coursesCards/3.png') }}" alt="image">
                    </div>
                    ...
                    <div class="coursesCard__content pl-20 sm:pl-10 pr-10">
                      ...
                      <div class="text-17 lh-13 fw-500 text-dark-1 mt-10">Angular - The Complete Guide (2022 Edition)</div>
                ...
                <div data-anim-child="slide-up delay-4" class="col-lg-6">
                  <a href="#" class="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                    <div class="coursesCard__image max-w-250 rounded-8">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/coursesCards/4.png') }}" alt="image">
                    </div>
                    ...
                    <div class="coursesCard__content pl-20 sm:pl-10 pr-10">
                      ...
                      <div class="text-17 lh-13 fw-500 text-dark-1 mt-10">The Ultimate Drawing Course Beginner to Advanced</div>
                ...
                <div data-anim-child="slide-up delay-5" class="col-lg-6">
                  <a href="#" class="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                    <div class="coursesCard__image max-w-250 rounded-8">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/coursesCards/5.png') }}" alt="image">
                    </div>
                    ...
                    <div class="coursesCard__content pl-20 sm:pl-10 pr-10">
                      ...
                      <div class="text-17 lh-13 fw-500 text-dark-1 mt-10">Photography Masterclass: A Complete Guide to Photography</div>
                ...
                <div data-anim-child="slide-up delay-6" class="col-lg-6">
                  <a href="#" class="coursesCard -type-4 d-flex sm:d-block items-center border-light rounded-8 px-10 py-10">
                    <div class="coursesCard__image max-w-250 rounded-8">
                      <img class="w-1/1 rounded-8" src="{{ asset('template/img/coursesCards/6.png') }}" alt="image">
                    </div>
                    ...
                    <div class="coursesCard__content pl-20 sm:pl-10 pr-10">
                      ...
                      <div class="text-17 lh-13 fw-500 text-dark-1 mt-10">Complete Blender Creator: Learn 3D Modelling for Beginners</div>
      ...
      <section class="section-bg layout-pt-lg layout-pb-sm bg-light-4">
        <div class="section-bg__item -full">
          <div class="bg-image js-lazy" data-bg="img/home-6/svg/bg.png') }}"></div>
        </div>

        <div data-anim-wrap class="container">
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-xl-6 col-lg-7">
              <div class="composition -type-2">
                <div class="-el-1">
                  <div class="bg-white rounded-8 px-40 py-40">
                    <div class="text-18 text-dark-1 lh-11 fw-500"><span class="text-purple-1">200+</span> Verified Teacher</div>

                    <div class="y-gap-20 pt-25">

                      <div class="d-flex items-center">
                        <img src="{{ asset('template/img/home-6/trust/1.png') }}" alt="image">
                        <div class="ml-20">
                          <div class="text-15 text-dark-1 lh-11 fw-500">Marvin McKinney</div>
                          <div class="text-13 lh-1 mt-5">Designer</div>
                        </div>
                      </div>

                      <div class="d-flex items-center">
                        <img src="{{ asset('template/img/home-6/trust/2.png') }}" alt="image">
                        <div class="ml-20">
                          <div class="text-15 text-dark-1 lh-11 fw-500">Ralph Edwards</div>
                          <div class="text-13 lh-1 mt-5">Designer</div>
                        </div>
                      </div>

                      <div class="d-flex items-center">
                        <img src="{{ asset('template/img/home-6/trust/3.png') }}" alt="image">
                        <div class="ml-20">
                          <div class="text-15 text-dark-1 lh-11 fw-500">Annette Black</div>
                          <div class="text-13 lh-1 mt-5">Designer</div>
                        </div>
                      </div>

                      <div class="d-flex items-center">
                        <img src="{{ asset('template/img/home-6/trust/4.png') }}" alt="image">
                        <div class="ml-20">
                          <div class="text-15 text-dark-1 lh-11 fw-500">Jane Cooper</div>
                          <div class="text-13 lh-1 mt-5">Designer</div>
                        </div>
                      </div>
                ...
                <div class="-el-2">
                  <div class="bg-white rounded-8">
                    <img class="w-1/1" src="{{ asset('template/img/home-6/trust/big.png') }}" alt="image">
                    <div class="px-20 py-20">
                      <div class="text-17 fw-500 text-dark-1">Wade Warren</div>
                      <div class="text-15 lh-1 mt-5">Marketing Coordinator</div>
                      <div class="d-flex x-gap-15 pt-15">
                        <div class="d-flex items-center">
                          <div class="icon-star text-11 text-yellow-1 mr-10"></div>
                          <div class="text-13 lh-12 text-yellow-1">4.5</div>
                        </div>

                        <div class="d-flex items-center">
                          <img class="shrink-0 mr-10" src="{{ asset('template/img/team/icons/1.svg') }}" alt="icon">
                          <div class="text-13 lh-12">692 Students</div>
                        </div>

                        <div class="d-flex items-center">
                          <img class="shrink-0 mr-10" src="{{ asset('template/img/team/icons/2.svg') }}" alt="icon">
            ...
            <div class="col-lg-5 col-md-10">
              <h2 class="text-30 lh-15">Truested By Best<br class="lg:d-none"> Teachers</h2>
              <p class="mt-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
              ...
              <div class="y-gap-20 pt-25">
                ...
                <div class="d-flex items-center">
                  ...
                  <div class="fw-500 text-dark-1">Last Education of Bachelor Degree</div>
                </div>
                ...
                <div class="d-flex items-center">
                  ...
                  <div class="fw-500 text-dark-1">More Than 15 Years Experience</div>
                </div>
                ...
                <div class="d-flex items-center">
                  ...
                  <div class="fw-500 text-dark-1">12 Education Award Winning</div>
                </div>

              </div>

              <div class="d-inline-block mt-35">
                <a href="#" class="button -md -dark-2 text-white">See More</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="svg-shape">
        <svg width="1925" height="261" viewBox="0 0 1925 261" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M1924.67 0L1922.7 7.03707C1911.58 46.7293 1877.25 75.5353 1836.23 79.5878L0 261V0H1924.67Z" fill="#F7F8FB" />
        </svg>
      </div>
      ...
      <section class="layout-pt-lg layout-pb-lg">
        <div data-anim-wrap class="container">
          ...
          <div class="overflow-hidden pt-50 js-section-slider" data-gap="30" data-loop data-pagination data-slider-cols="base-1 xl-6 lg-4 md-3 sm-2">
            <div class="swiper-wrapper">

              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-2" class="bg-white border-light rounded-8 -featureCard-hover-2">
                  <div class="py-30 px-40 text-center">
                    <div class="featureCard__icon size-90 mx-auto d-flex items-center justify-center rounded-full bg-light-3">
                      <i class="icon-architecture text-40"></i>
                    </div>
                    <div class="featureCard__title text-17 fw-500 text-dark-1 mt-20">Design Creative</div>
                    <div class="featureCard__text text-13 lh-1 mt-10">573+ Courses</div>
                  </div>
                </div>
              </div>

              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-3" class="bg-white border-light rounded-8 -featureCard-hover-2">
                  <div class="py-30 px-40 text-center">
                    <div class="featureCard__icon size-90 mx-auto d-flex items-center justify-center rounded-full bg-light-3">
                      <i class="icon-megaphone text-40"></i>
                    </div>
                    <div class="featureCard__title text-17 fw-500 text-dark-1 mt-20">Sales Marketing</div>
                    <div class="featureCard__text text-13 lh-1 mt-10">565+ Courses</div>
                  </div>
                </div>
              </div>

              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-4" class="bg-white border-light rounded-8 -featureCard-hover-2">
                  <div class="py-30 px-40 text-center">
                    <div class="featureCard__icon size-90 mx-auto d-flex items-center justify-center rounded-full bg-light-3">
                      <i class="icon-save-money text-40"></i>
                    </div>
                    <div class="featureCard__title text-17 fw-500 text-dark-1 mt-20">Development IT</div>
                    <div class="featureCard__text text-13 lh-1 mt-10">126+ Courses</div>
                  </div>
                </div>
              </div>

              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-5" class="bg-white border-light rounded-8 -featureCard-hover-2">
                  <div class="py-30 px-40 text-center">
                    <div class="featureCard__icon size-90 mx-auto d-flex items-center justify-center rounded-full bg-light-3">
                      <i class="icon-software text-40"></i>
                    </div>
                    <div class="featureCard__title text-17 fw-500 text-dark-1 mt-20">Engineering Architecture</div>
                    <div class="featureCard__text text-13 lh-1 mt-10">35+ Courses</div>
                  </div>
                </div>
              </div>

              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-6" class="bg-white border-light rounded-8 -featureCard-hover-2">
                  <div class="py-30 px-40 text-center">
                    <div class="featureCard__icon size-90 mx-auto d-flex items-center justify-center rounded-full bg-light-3">
                      <i class="icon-tools text-40"></i>
                    </div>
                    <div class="featureCard__title text-17 fw-500 text-dark-1 mt-20">Personal Development</div>
                    <div class="featureCard__text text-13 lh-1 mt-10">908+ Courses</div>
                  </div>
                </div>
              </div>

              <div class="swiper-slide">
                <div data-anim-child="slide-left delay-7" class="bg-white border-light rounded-8 -featureCard-hover-2">
                  <div class="py-30 px-40 text-center">
                    <div class="featureCard__icon size-90 mx-auto d-flex items-center justify-center rounded-full bg-light-3">
                      <i class="icon-person-2 text-40"></i>
                    </div>
                    <div class="featureCard__title text-17 fw-500 text-dark-1 mt-20">Finance Accounting</div>
                    <div class="featureCard__text text-13 lh-1 mt-10">129+ Courses</div>
                  </div>
                </div>
              </div>
            ...
            <div class="d-flex x-gap-15 items-center justify-center pt-50">
              <div class="col-auto">
        ...
        <div data-anim-wrap class="container">
          <div class="row y-gap-30 items-center">
            <div class="col-lg-6 col-md-10">
              <h2 class="text-30 lh-15 text-white">People Love To Learn With Educrat</h2>
              <p class="text-white mt-10">Lorem ipsum dolor sit amet, consectetur.</p>
      ...
      <section class="pt-45 pb-15 bg-dark-2">
        <div class="container">
          <div class="row justify-center">
            <div class="col text-center">
              <p class="text-lg text-white">Trusted by the world’s best</p>
            </div>
          </div>
          ...
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-xl-5 col-lg-6 col-md-9 lg:order-2">
              ...
              <div class="d-inline-block mt-30">
                <a href="#" class="button -md -dark-1 text-white">Join Free</a>
              </div>
            </div>
            ...
            <div class="col-lg-6 lg:order-1">
              <div class="composition -type-3">
                ...
                <div class="-el-2">
                  <img class="w-1/1" src="{{ asset('template/img/home-6/learn/1.png') }}" alt="image">
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="layout-pt-lg bg-purple-1">
        <div data-anim-wrap class="container">
          <div class="row y-gap-30 items-center">
            <div class="col-lg-5">
              <div class="bg-white rounded-16 px-30 py-30">
                <h3 class="text-20 lh-15 text-center">Create Your <span class="text-purple-1">Free Account</span></h3>
                <form action="https://creativelayers.net/themes/educrat-html/post" class="contact-form row y-gap-30 pt-30">
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    <button class="button -md -purple-1 w-1/1 text-white">Start Learning For Free</button>
                    <div class="text-13 lh-17 mt-15">By continuing, you accept our Terms of Use, our Privacy Policy and that your data is stored in the USA. You confirm you are at least 16 years old (13 if you are an authorized Classrooms user).</div>
                  </div>
                </form>
              </div>
            </div>

            <div class="offset-xl-2 col-xl-4 offset-lg-1 col-lg-5 col-md-9">
              <h2 class="text-30 lh-13 text-white">Register Now and Get a 70% Discount</h2>
              <p class="text-lg text-white mt-10">Get 100 Online Courses For Free</p>

              <div class="js-countdown">
                <div class="row x-gap-50 y-gap-30 pt-60 lg:pt-30">

                  <div class="col-md-auto col-6">
                    <div class="text-center text-white">
                      <div class="text-45 lh-12 fw-700 js-countdown-days">20</div>
                      <div class="mt-5">Days</div>
                    </div>
                  </div>

                  <div class="col-md-auto col-6">
                    <div class="text-center text-white">
                      <div class="text-45 lh-12 fw-700 js-countdown-hours">32</div>
                      <div class="mt-5">Hours</div>
                    </div>
                  </div>

                  <div class="col-md-auto col-6">
                    <div class="text-center text-white">
                      <div class="text-45 lh-12 fw-700 js-countdown-minutes">57</div>
                      <div class="mt-5">Minutes</div>
                    </div>
                  </div>

                  <div class="col-md-auto col-6">
                    <div class="text-center text-white">
                      <div class="text-45 lh-12 fw-700 js-countdown-seconds">13</div>
                      <div class="mt-5">Seconds</div>
                    </div>
                  </div>
        ...
        <div data-anim-wrap class="container">
          <div data-anim-child="slide-left delay-1" class="row y-gap-20 justify-between items-center">
            ...
            <div class="col-auto">
              ...
              <a href="#" class="button -icon -purple-3 text-purple-1 -rounded">
                Browse Event
          ...
          <div class="pt-60 lg:pt-40">
            <div class="overflow-hidden js-section-slider" data-gap="30" data-loop data-pagination data-slider-cols="xl-4 lg-3 md-2 sm-1 base-1">
              <div class="swiper-wrapper">

                <div class="swiper-slide">
                  <div data-anim-child="slide-left delay-2" class="bg-white rounded-8 shadow-1 px-20 py-20">
                    <div class="d-flex items-center">
                      <div class="size-60 d-flex flex-column justify-center items-center rounded-8 bg-dark-1 text-center mr-20">
                        <div class="text-17 lh-15 text-white fw-500">15</div>
                        <div class="lh-1 text-white fw-500">JUNE</div>
                      </div>
                      <div class="text-17 lh-15 text-dark-1 fw-500">Medical Chemistry: The Molecular Basis</div>
                    </div>

                    <div class="d-flex items-center mt-20">
                      <div class="icon-location text-14 mr-10"></div>
                      <div class="text-14 lh-1">London, UK</div>
                    </div>
                  </div>
                </div>

                <div class="swiper-slide">
                  <div data-anim-child="slide-left delay-3" class="bg-white rounded-8 shadow-1 px-20 py-20">
                    <div class="d-flex items-center">
                      <div class="size-60 d-flex flex-column justify-center items-center rounded-8 bg-dark-1 text-center mr-20">
                        <div class="text-17 lh-15 text-white fw-500">15</div>
                        <div class="lh-1 text-white fw-500">JUNE</div>
                ...
                <div class="swiper-slide">
                  <div data-anim-child="slide-left delay-4" class="bg-white rounded-8 shadow-1 px-20 py-20">
                    <div class="d-flex items-center">
                      <div class="size-60 d-flex flex-column justify-center items-center rounded-8 bg-dark-1 text-center mr-20">
                        <div class="text-17 lh-15 text-white fw-500">15</div>
                        <div class="lh-1 text-white fw-500">JUNE</div>
                ...
                <div class="swiper-slide">
                  <div data-anim-child="slide-left delay-5" class="bg-white rounded-8 shadow-1 px-20 py-20">
                    <div class="d-flex items-center">
                      <div class="size-60 d-flex flex-column justify-center items-center rounded-8 bg-dark-1 text-center mr-20">
                        <div class="text-17 lh-15 text-white fw-500">15</div>
                        <div class="lh-1 text-white fw-500">JUNE</div>
                ...
                <div class="swiper-slide">
                  <div data-anim-child="slide-left delay-6" class="bg-white rounded-8 shadow-1 px-20 py-20">
                    <div class="d-flex items-center">
                      <div class="size-60 d-flex flex-column justify-center items-center rounded-8 bg-dark-1 text-center mr-20">
                        <div class="text-17 lh-15 text-white fw-500">15</div>
                        <div class="lh-1 text-white fw-500">JUNE</div>
                ...
                <div class="swiper-slide">
                  <div data-anim-child="slide-left delay-7" class="bg-white rounded-8 shadow-1 px-20 py-20">
                    <div class="d-flex items-center">
                      <div class="size-60 d-flex flex-column justify-center items-center rounded-8 bg-dark-1 text-center mr-20">
                        <div class="text-17 lh-15 text-white fw-500">15</div>
                        <div class="lh-1 text-white fw-500">JUNE</div>
      ...
      <section class="layout-pt-lg layout-pb-lg">
        <div data-anim-wrap class="container">
          ...
          <div class="row y-gap-30 pt-60">
            ...
            <div class="col-lg-3 col-md-6" data-anim-child="slide-left delay-2">
              <a href="blog-single.html" class="blogCard -type-1">
                ...
                <div class="blogCard__content mt-20">
                  ...
                  <h4 class="blogCard__title text-17 lh-15 mt-10">Eco-Education in Our Lives: We Can Change the Future</h4>
                  <div class="blogCard__date text-14 mt-5">December 16, 2022</div>
                </div>
              </a>
            </div>

            <div class="col-lg-3 col-md-6" data-anim-child="slide-left delay-3">
              <a href="blog-single.html" class="blogCard -type-1">
                <div class="blogCard__image">
            ...
            <div class="col-lg-3 col-md-6" data-anim-child="slide-left delay-4">
              <a href="blog-single.html" class="blogCard -type-1">
                <div class="blogCard__image">
            ...
            <div class="col-lg-3 col-md-6" data-anim-child="slide-left delay-5">
              <a href="blog-single.html" class="blogCard -type-1">
                <div class="blogCard__image">
      ...
      <section class="section-bg pt-80 pb-80 lg:pt-60 lg:pb-60 mb-80">
        <div class="section-bg__item bg-light-7"></div>
        <div class="container">
          <div class="row y-gap-30 justify-between items-center">
            <div class="col-xl-5 col-lg-6 col-md-10">
              <div class="pl-60 lg:pl-0">
                <h2 class="text-30 lh-12">Download the App</h2>
                <p class="mt-30">New features. New appearance. No risk<br class="lg:d-none"> and credit card required.</p>
            ...
            <div class="col-lg-6">
              <img src="{{ asset('template/img/home-6/app/1.png') }}" alt="image">
            </div>
          </div>
        </div>
      </section>
