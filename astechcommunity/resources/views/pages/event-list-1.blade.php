              ...
              <div class="tabs__pane -tab-item-1 is-active">
                <div data-anim="slide-up delay-4" class="row y-gap-30 pt-30">
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="eventCard -type-1">
                      <div class="eventCard__img">
                        <img src="{{ asset('template/img/courses-list/1.png') }}" alt="image">
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="eventCard -type-1">
                      <div class="eventCard__img">
                        <img src="{{ asset('template/img/courses-list/2.png') }}" alt="image">
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="eventCard -type-1">
                      <div class="eventCard__img">
                        <img src="{{ asset('template/img/courses-list/3.png') }}" alt="image">
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="eventCard -type-1">
                      <div class="eventCard__img">
                        <img src="{{ asset('template/img/courses-list/4.png') }}" alt="image">
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="eventCard -type-1">
                      <div class="eventCard__img">
                        <img src="{{ asset('template/img/courses-list/5.png') }}" alt="image">
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="eventCard -type-1">
                      <div class="eventCard__img">
                        <img src="{{ asset('template/img/courses-list/6.png') }}" alt="image">
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="eventCard -type-1">
                      <div class="eventCard__img">
                        <img src="{{ asset('template/img/courses-list/7.png') }}" alt="image">
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="eventCard -type-1">
                      <div class="eventCard__img">
                        <img src="{{ asset('template/img/courses-list/8.png') }}" alt="image">
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="eventCard -type-1">
                      <div class="eventCard__img">
                        <img src="{{ asset('template/img/courses-list/9.png') }}" alt="image">
                      </div>
