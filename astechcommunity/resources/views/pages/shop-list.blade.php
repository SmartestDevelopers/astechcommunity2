            ...
            <div class="col-lg-9">
              ...
              <div class="row y-gap-30 pt-30">
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="productCard -type-1 text-center">
                    <div class="productCard__image">
                      <img src="{{ asset('template/img/shop/products/5.png') }}" alt="Product image">
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="productCard -type-1 text-center">
                    <div class="productCard__image">
                      <img src="{{ asset('template/img/shop/products/6.png') }}" alt="Product image">
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="productCard -type-1 text-center">
                    <div class="productCard__image">
                      <img src="{{ asset('template/img/shop/products/7.png') }}" alt="Product image">
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="productCard -type-1 text-center">
                    <div class="productCard__image">
                      <img src="{{ asset('template/img/shop/products/8.png') }}" alt="Product image">
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="productCard -type-1 text-center">
                    <div class="productCard__image">
                      <img src="{{ asset('template/img/shop/products/9.png') }}" alt="Product image">
